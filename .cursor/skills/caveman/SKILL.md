...
- **Procedure/function documentation headers**, code comments, commit messages, PR descriptions: written in normal grammar per `dev-standards-core.mdc`, not in caveman.
...
- Procedure/function header documentation per `dev-standards-core.mdc`.
