...
When creating or modifying MXL spreadsheet layouts as part of a feature, update SDD artifacts if present (see `.cursor/rules/sdd-integrations.mdc` for detection):
