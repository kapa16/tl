...
Delegate to the **`1c-metadata-manager`** subagent (defined in `.cursor/agents/metadata-manager.md` for Cursor, or the active tool's agents directory after install) when **any** of the following is true:
