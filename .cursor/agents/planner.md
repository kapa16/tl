...
- Follow `.cursor/rules/dev-standards-architecture.mdc` for architecture patterns, extensions, and platform standards
...
See `.cursor/rules/anti-patterns.mdc` for anti-patterns to watch for during planning.
