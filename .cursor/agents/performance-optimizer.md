...
See `.cursor/rules/anti-patterns.mdc` for complete list with code examples.

**Development standards:** Follow `.cursor/rules/dev-standards-core.mdc` (project parameters, code style, naming).
...
**Pattern:** See the relevant section of `.cursor/rules/anti-patterns.mdc`
