...
Процедура ПриОткрытии(Отказ)
	...
	Если ОписаниеОповещенияОЗакрытии.ДополнительныеПараметры.Свойство("РедактируемоеПоле") Тогда
		...
		ИначеЕсли Тип = "Image" Тогда
			...
			РазмерШрифта = 8;
			Ориентация = ОписаниеПоля.Ориентация;
			РазмерКартинки = ОписаниеПоля.РазмерКартинки;
...
Процедура СформироватьОписаниеОповещенияОЗакрытии()
	...
	ИначеЕсли Тип = "Image" Тогда
		...
		ОписаниеОповещенияОЗакрытии.ДополнительныеПараметры.ОписаниеПоля.Вставить("ТолщинаРамки", ТолщинаРамки);
		ОписаниеОповещенияОЗакрытии.ДополнительныеПараметры.ОписаниеПоля.Вставить("Ориентация", Ориентация);		
		ОписаниеОповещенияОЗакрытии.ДополнительныеПараметры.ОписаниеПоля.Вставить("РазмерКартинки", РазмерКартинки);
	КонецЕсли;
...
&НаКлиенте
Процедура ВыборФайлаЗавершить(Адрес, ДополнительныеПараметры) Экспорт
	
	Если НЕ ЗначениеЗаполнено(Адрес) Тогда
		Возврат;
	КонецЕсли;
	
	ДвоичныеДанныеКартинки = ПолучитьИзВременногоХранилища(Адрес.Хранение);
...
&НаКлиенте
Процедура ВыбратьФайлДляЗначенияПоУмолчаниюЗавершить(Адрес, ДополнительныеПараметры) Экспорт
