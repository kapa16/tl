...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Обход особенности поведения платформы, при превышении лимита вводимых символов.
	Строка25000 = Новый ОписаниеТипов("Строка", , Новый КвалификаторыСтроки(25000, ДопустимаяДлина.Переменная));
	Элементы.ДоверенностьДокументДоверСвПолнТекстПолн.ОграничениеТипа = Строка25000;
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверСвРосОргАдрРегАдрРФНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвУпПредПредСведФизЛСведФЛАдрМЖАдрРФНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверЛицоБезДовСВЮЛСвЮЛЕИОАдрРегАдрРФНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвУпПредПредСведФизЛСведФЛАдрМЖРегионАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверЛицоБезДовСВЮЛСвЮЛЕИОАдрРегРегионАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверСвРосОргАдрРегРегионАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверСвРосОргКонтактТлфНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвДоверитДоверитИПДоверСведФЛКонтактТлфНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвУпПредПредСведФизЛСведФЛУдЛичнФЛКодВидДокПриИзменении(Элемент)
	
	ПоляУдостоверяющиеЛичностьФизическогоЛица 
		= Доверенность[0].Документ[0].Довер[0].СвУпПред[0].Пред[0].СведФизЛ[0].СведФЛ[0].УдЛичнФЛ[0];
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвУпПредПредСведИПСведФЛУдЛичнФЛКодВидДокПриИзменении(Элемент)
	
	ПоляУдостоверяющиеЛичностьФизическогоЛица 
		= Доверенность[0].Документ[0].Довер[0].СвУпПред[0].Пред[0].СведИП[0].СведФЛ[0].УдЛичнФЛ[0]; 
	МашиночитаемыеДоверенностиКлиент.СброситьОформлениеИОчиститьПоляДокументаУдостоверяющегоЛичность(Элемент,
		ПоляУдостоверяющиеЛичностьФизическогоЛица);
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвУпПредПредСведФизЛСведФЛУдЛичнФЛКодВидДокОчистка(Элемент, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвУпПредПредСведИПСведФЛУдЛичнФЛКодВидДокОчистка(Элемент, СтандартнаяОбработка)
...
Процедура ПодписатьИЗарегистрировать(Команда)
	...
	ПодключитьОбработчикОжидания("ВыполнитьПодписатьИЗарегистрировать", 0.2, Истина);	
			
КонецПроцедуры

&НаКлиенте
Процедура ВыполнитьПодписатьИЗарегистрировать()
...
Процедура ПерезаполнитьСведенияОДоверителе(Доверитель)
	...
	Если ЗначениеЗаполнено(Доверитель) И ОбщегоНазначения.ЭтоСсылка(ТипЗнч(Доверитель)) Тогда
		...
		Если ИнтеграцияЭДО.ЭтоФизЛицо(Доверитель) Тогда
			...
			КонтактнаяИнформация = ИнтеграцияБСПБЭД.КонтактнаяИнформацияОбъекта(Доверитель, "Телефон");
			СведенияОбИП.СведФЛ[0].КонтактТлф = КонтактнаяИнформация.Представление;
			
			ПоказатьГруппу(Элементы.ГруппаДоверитель, Элементы.ГруппаДоверитель_ИндивидуальныйПредприниматель);
			СброситьОформлениеЭлементовФормы(Элементы.ГруппаДоверитель_ИндивидуальныйПредприниматель,
				Истина);
		Иначе
			...
			КонтактнаяИнформация = ИнтеграцияБСПБЭД.КонтактнаяИнформацияОбъекта(Доверитель, "Телефон");
			СведенияОЮрЛице.КонтактТлф = КонтактнаяИнформация.Представление;
			...
			СброситьОформлениеЭлементовФормы(Элементы.ГруппаДоверитель_ЮридическоеЛицо, Истина);
		КонецЕсли;
		
		СброситьОформлениеЭлементовФормы(Элементы.ДоверенностьДокументДоверСвДоверит_Доверитель);
	КонецЕсли;
КонецПроцедуры
...
Процедура ПерезаполнитьСведенияОЛицеБезДоверенности(ЛицоБезДоверенности)
	...
	Если ЗначениеЗаполнено(ЛицоБезДоверенности) И ОбщегоНазначения.ЭтоСсылка(ТипЗначения) Тогда
		...
		Если Метаданные.ОпределяемыеТипы.ФизическоеЛицо.Тип.СодержитТип(ТипЗначения) Тогда
			...
			СброситьОформлениеЭлементовФормы(Элементы.ГруппаЛицоБезДоверенности_ФизическоеЛицо, Истина);
		Иначе
			...
			Если ИнтеграцияЭДО.ЭтоФизЛицо(ЛицоБезДоверенности) Тогда
				...
				СброситьОформлениеЭлементовФормы(Элементы.ГруппаЛицоБезДоверенности_ИндивидуальныйПредприниматель, Истина);
			Иначе
				Доверенность[0].Документ[0].Довер[0].СвДоверит[0].Доверит[0].РосОргДовер[0].ЕИОФЛ = ДаНет.Нет;
				...
				Если Метаданные.ОпределяемыеТипы.Организация.Тип.СодержитТип(ТипЗначения) Тогда
					...
					КонецЕсли;
				КонецЕсли;
				СброситьОформлениеЭлементовФормы(Элементы.ГруппаЛицоБезДоверенности_ЮридическоеЛицо, Истина);
			КонецЕсли;
		КонецЕсли;
		
		СброситьОформлениеЭлементовФормы(Элементы.ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверЛицоБезДов_ЛицоБезДоверенности);	
	КонецЕсли;
КонецПроцедуры
...
Процедура ПерезаполнитьСведенияОПредставителе(Представитель)
	...
	Если ЗначениеЗаполнено(Представитель) И ОбщегоНазначения.ЭтоСсылка(ТипЗначения) Тогда
		...
		СброситьОформлениеЭлементовФормы(Элементы.ДоверенностьДокументДоверСвУпПред_Представитель);	
	КонецЕсли;
КонецПроцедуры
...
Процедура ПерезаполнитьСведенияОФизическомЛице(ФизическоеЛицо)
	...
	Если ЗначениеЗаполнено(ФизическоеЛицо) И ОбщегоНазначения.ЭтоСсылка(ТипЗнч(ФизическоеЛицо)) Тогда
		...
		СброситьОформлениеЭлементовФормы(Элементы.ГруппаОдноВложенноеЛицоДействующееБезДоверенности, Истина);
	КонецЕсли;
КонецПроцедуры
...
Процедура ЗаполнитьСписокРегионов()
	...
	Если СписокРегионов = Неопределено Тогда
		...
		Элементы.ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверЛицоБезДовСВЮЛСвЮЛЕИОАдрРегРегион.РежимВыбораИзСписка
			= Ложь;
		Элементы.ДоверенностьДокументДоверСвУпПредПредСведФизЛСведФЛАдрМЖРегион.РежимВыбораИзСписка = Ложь;
	Иначе
		
		Элементы.ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверСвРосОргАдрРегРегион.РежимВыбораИзСписка = Истина;
		Элементы.ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверЛицоБезДовСВЮЛСвЮЛЕИОАдрРегРегион.РежимВыбораИзСписка
			= Истина;
		Элементы.ДоверенностьДокументДоверСвУпПредПредСведФизЛСведФЛАдрМЖРегион.РежимВыбораИзСписка = Истина;
		...
		Для Каждого Регион Из СписокРегионов Цикл
			...
			Элементы.ДоверенностьДокументДоверСвУпПредПредСведФизЛСведФЛАдрМЖРегион.СписокВыбора
				.Добавить(Код, Наименование);
...
Процедура ДоверительПоУмолчанию(Форма)
	...
	СброситьОформлениеЭлементовФормы(Форма.Элементы.ГруппаДоверитель_ЮридическоеЛицо, Истина);
...
Процедура ЛицоБезДоверенностиПоУмолчанию(Форма)
	...
	СброситьОформлениеЭлементовФормы(Форма.Элементы.ГруппаЛицоБезДоверенности_ФизическоеЛицо, Истина);
КонецПроцедуры
...
Процедура ПредставительПоУмолчанию(Форма)
	...
	СброситьОформлениеЭлементовФормы(Форма.Элементы.ГруппаПредставитель_ФизическоеЛицо, Истина);
...
Процедура НастроитьЭлементыСФиксированнымиСпискамиЗначений()
	...
	НастраиваемыеЭлементы.Добавить(Элементы.ДоверенностьДокументДоверСвУпПредПредСведФизЛСведФЛАдрМЖРегион);
...
Процедура ВыбратьМашинноеПолномочиеЗавершение(Результат, ИдентификаторСтроки = Неопределено) Экспорт
	...
	КонецЕсли;
	СброситьОформлениеЭлементовФормы(Элементы.ГруппаМашиночитаемыеПолномочия, Истина);
	ОбновитьВидимостьКомандТаблицыПолномочий(ЭтотОбъект);
	ОбновитьНумерациюТаблицы(Доверенность[0].Документ[0].Довер[0].СвПолн[0].МашПолн);
КонецПроцедуры
...
Процедура НачатьРедактированиеТелефона(СтандартнаяОбработка, ИмяЭлемента)
	...
	Телефон = "";
	Если ИмяЭлемента = "ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверСвРосОргКонтактТлф" Тогда
		Телефон = Доверенность[0].Документ[0].Довер[0].СвДоверит[0].Доверит[0].РосОргДовер[0].СвРосОрг[0].КонтактТлф;
	ИначеЕсли ИмяЭлемента = "ДоверенностьДокументДоверСвДоверитДоверитИПДоверСведФЛКонтактТлф" Тогда
		Телефон = Доверенность[0].Документ[0].Довер[0].СвДоверит[0].Доверит[0].ИПДовер[0].СведФЛ[0].КонтактТлф;
	КонецЕсли;
...
Процедура ПослеВводаНомераТелефона(Результат, ИмяЭлемента) Экспорт 
	...
	Если ИмяЭлемента = "ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверСвРосОргКонтактТлф" Тогда
		Доверенность[0].Документ[0].Довер[0].СвДоверит[0].Доверит[0].РосОргДовер[0].СвРосОрг[0].КонтактТлф = Результат.Представление;
	ИначеЕсли ИмяЭлемента = "ДоверенностьДокументДоверСвДоверитДоверитИПДоверСведФЛКонтактТлф" Тогда
		Доверенность[0].Документ[0].Довер[0].СвДоверит[0].Доверит[0].ИПДовер[0].СведФЛ[0].КонтактТлф = Результат.Представление;
	КонецЕсли;
...
Процедура НачатьРедактированиеАдресаОрганизации(ИмяЭлемента, ЗаголовокОкнаРедактирования = "")
	...
	Адрес = "";
	Если ИмяЭлемента = "ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверСвРосОргАдрРегАдрРФ" Тогда
		Адрес = Доверенность[0].Документ[0].Довер[0].СвДоверит[0].Доверит[0].РосОргДовер[0].СвРосОрг[0].АдрРег[0].АдрРФ;
	ИначеЕсли ИмяЭлемента = "ДоверенностьДокументДоверСвУпПредПредСведФизЛСведФЛАдрМЖАдрРФ" Тогда 
		Адрес = Доверенность[0].Документ[0].Довер[0].СвУпПред[0].Пред[0].СведФизЛ[0].СведФЛ[0].АдрМЖ[0].АдрРФ;
	ИначеЕсли ИмяЭлемента = "ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверЛицоБезДовСВЮЛСвЮЛЕИОАдрРегАдрРФ" Тогда 
		Адрес = Доверенность[0].Документ[0].Довер[0].СвДоверит[0].Доверит[0].РосОргДовер[0].ЛицоБезДов[0].СВЮЛ[0].СвЮЛЕИО[0].АдрРег[0].АдрРФ;
	КонецЕсли;
...
Процедура ЗакончитьРедактированиеАдресаОрганизацииНаСервере(Результат, ИмяЭлемента)
	...
	Если ИмяЭлемента = "ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверСвРосОргАдрРегАдрРФ" Тогда
		Доверенность[0].Документ[0].Довер[0].СвДоверит[0].Доверит[0].РосОргДовер[0].СвРосОрг[0].АдрРег[0].АдрРФ = Результат.Представление;
		Доверенность[0].Документ[0].Довер[0].СвДоверит[0].Доверит[0].РосОргДовер[0].СвРосОрг[0].АдрРег[0].Регион = СведенияОбАдресе.КодРегиона;
	ИначеЕсли ИмяЭлемента = "ДоверенностьДокументДоверСвУпПредПредСведФизЛСведФЛАдрМЖАдрРФ" Тогда 
		Доверенность[0].Документ[0].Довер[0].СвУпПред[0].Пред[0].СведФизЛ[0].СведФЛ[0].АдрМЖ[0].АдрРФ = Результат.Представление;
		Доверенность[0].Документ[0].Довер[0].СвУпПред[0].Пред[0].СведФизЛ[0].СведФЛ[0].АдрМЖ[0].Регион = СведенияОбАдресе.КодРегиона;
	ИначеЕсли ИмяЭлемента = "ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверЛицоБезДовСВЮЛСвЮЛЕИОАдрРегАдрРФ" Тогда 
		Доверенность[0].Документ[0].Довер[0].СвДоверит[0].Доверит[0].РосОргДовер[0].ЛицоБезДов[0].СВЮЛ[0].СвЮЛЕИО[0].АдрРег[0].АдрРФ = Результат.Представление;
		Доверенность[0].Документ[0].Довер[0].СвДоверит[0].Доверит[0].РосОргДовер[0].ЛицоБезДов[0].СВЮЛ[0].СвЮЛЕИО[0].АдрРег[0].Регион = СведенияОбАдресе.КодРегиона;
	КонецЕсли;
