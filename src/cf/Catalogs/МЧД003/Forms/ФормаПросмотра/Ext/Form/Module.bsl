...
Процедура ЗарегистрироватьВРРФНС(Команда)
	...
	Иначе
		Если ЗначениеЗаполнено(РезультатРегистрации.ОписаниеОшибкиРегистрации) Тогда
			...
			Если МашиночитаемыеДоверенностиКлиентСервер.РодительскаяМЧДОтсутствуетВРеестре(РезультатРегистрации.ОписаниеОшибкиРегистрации) Тогда
				Результат.ОписаниеОшибкиРегистрации = 
					МашиночитаемыеДоверенностиКлиентСервер.ПредставлениеОтсутствияРодительскойМЧДВРеестреФНС();
			КонецЕсли;
			
			Прочитать();
			Объект.ОписаниеОшибкиРегистрации = Результат.ОписаниеОшибкиРегистрации;
...
&НаКлиенте
Процедура ВыгрузитьВОблачныйЭДО(Команда)
	
	МодульМашиночитаемыеДоверенностиИнтеграцияОблакаКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль(
		"МашиночитаемыеДоверенностиИнтеграцияОблакаКлиент");
	МодульМашиночитаемыеДоверенностиИнтеграцияОблакаКлиент.ВыгрузитьВОблачныйЭДО(
