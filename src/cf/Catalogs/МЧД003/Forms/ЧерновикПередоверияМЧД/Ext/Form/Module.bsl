...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	Если ЗначениеЗаполнено(ТекущаяИсходнаяМЧД) Тогда
...
&НаКлиенте
Процедура ДоверенностьДокументПередовСвПолучПолнПредСведФизЛСведФЛАдрМЖАдрРФНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	ЗаголовокОкнаРедактирования = НСтр("ru = 'Адрес места проживания'");
	НачатьРедактированиеАдресаОрганизации(Элемент.Имя, ЗаголовокОкнаРедактирования);
	
КонецПроцедуры

&НаКлиенте
Процедура ДоверенностьДокументПередовСвПередПолнПередПолнРосОргПерПолнЛицоБезДовСВЮЛСвЮЛЕИОАдрРегАдрРФНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	НачатьРедактированиеАдресаОрганизации(Элемент.Имя);
	
КонецПроцедуры

&НаКлиенте
Процедура ДоверенностьДокументПередовСвПередПолнПередПолнФилПерПолнСвФилАдрРегАдрРФНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументПередовСвПолучПолнПредСведФизЛСведФЛАдрМЖРегионАвтоПодбор(
			Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументПередовСвПередПолнПередПолнРосОргПерПолнЛицоБезДовСВЮЛСвЮЛЕИОАдрРегРегионАвтоПодбор(
			Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументПередовСвПередПолнПередПолнРосОргПерПолнСвРосОргАдрРегРегионАвтоПодбор(
			Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументПередовСвПередПолнПередПолнФилПерПолнСвФилАдрРегРегионАвтоПодбор(
			Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументПередовСвПередПолнПередПолнРосОргПерПолнСвРосОргАдрРегАдрРФНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументПередовСвПередПолнПередПолнРосОргПерПолнСвРосОргКонтактТлфНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	
	НачатьРедактированиеТелефона(СтандартнаяОбработка, Элемент.Имя);
	
КонецПроцедуры

&НаКлиенте
Процедура ДоверенностьДокументПередовСвПередПолнПередПолнФилПерПолнСвФилКонтактТлфНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументПередовСвПередПолнПередПолнИнПерПолнСвИнОргКонтактТлфНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументПередовСвПередПолнПередПолнИнПерПолнСвИнОргАдрМНФактАдрРФНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументПередовСвПолучПолнПредСведФизЛСведФЛУдЛичнФЛКодВидДокПриИзменении(Элемент)

	ПоляУдостоверяющиеЛичностьФизическогоЛица 
		= Доверенность[0].Документ[0].Передов[0].СвПолучПолн[0].Пред[0].СведФизЛ[0].СведФЛ[0].УдЛичнФЛ[0];
	МашиночитаемыеДоверенностиКлиент.СброситьОформлениеИОчиститьПоляДокументаУдостоверяющегоЛичность(Элемент,
		ПоляУдостоверяющиеЛичностьФизическогоЛица);
	
КонецПроцедуры

&НаКлиенте
Процедура ДоверенностьДокументПередовСвПолучПолнПредСведИПСведФЛУдЛичнФЛКодВидДокПриИзменении(Элемент)
	
	ПоляУдостоверяющиеЛичностьФизическогоЛица
		 = Доверенность[0].Документ[0].Передов[0].СвПолучПолн[0].Пред[0].СведИП[0].СведФЛ[0].УдЛичнФЛ[0];
	МашиночитаемыеДоверенностиКлиент.СброситьОформлениеИОчиститьПоляДокументаУдостоверяющегоЛичность(Элемент,
		ПоляУдостоверяющиеЛичностьФизическогоЛица);
...
&НаКлиенте
Процедура ДоверенностьДокументПередовСвПолучПолнПредСведФизЛСведФЛУдЛичнФЛКодВидДокОчистка(Элемент, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументПередовСвПолучПолнПредСведИПСведФЛУдЛичнФЛКодВидДокОчистка(Элемент, СтандартнаяОбработка)
...
Процедура ПодписатьИЗарегистрировать(Команда)
	...
	ТипПодписи = НастройкиЭДОВызовСервера.ТипПодписи(ТипПредметаПодписания);
	
	Если Не КриптографияБЭДКлиент.ЭтоТипПодписиCAdESBES(ТипПодписи) Тогда
		...
		ДатаВыдачиОтличаетсяБолееЧемНаДень = Не (СвПереДовер.ДатаВыдДовер >= НачалоДиапазона И СвПереДовер.ДатаВыдДовер <= КонецДиапазона);
...
Процедура ПерезаполнитьСведенияОДоверителе(ОписаниеДоверителя)
	...
	Если СвПередПолн[0].ТипПерПолн = ТипыПередоверителей.ЮридическоеЛицо Тогда
		...
		СброситьОформлениеЭлементовФормы(Элементы.ГруппаДоверительПередоверия_ЮридическоеЛицо, Истина);
	ИначеЕсли СвПередПолн[0].ТипПерПолн = ТипыПередоверителей.ФилиалИностраннойОрганизации Тогда
		...
		СброситьОформлениеЭлементовФормы(Элементы.ГруппаДоверительПередоверия_ФилиалИностраннойОрганизации, Истина);
	...
	ИначеЕсли СвПередПолн[0].ТипПерПолн = ТипыПередоверителей.ФилиалЮридическогоЛица Тогда
		...
		СброситьОформлениеЭлементовФормы(Элементы.ГруппаДоверительПередоверия_ФилиалОрганизации, Истина);
...
Процедура ЗаполнитьМашиночитаемыеПолномочияОтРодителя(ОбъектXDTOМЧД)
	...
	Если Доверенность[0].Документ[0].Передов[0].СвПолн[0].ТипПолн = ТипыПолномочий().Текстовые Тогда
		...
		СброситьОформлениеЭлементовФормы(Элементы.ГруппаТекстовыеПолномочияПередоверия, Истина);
	Иначе
		...
		СброситьОформлениеЭлементовФормы(Элементы.ГруппаМашиночитаемыеПолномочияПередоверия, Истина);
	КонецЕсли;
...
Процедура ПерезаполнитьСведенияОЛицеБезДоверенностиПередоверия(ЛицоБезДоверенности)
	...
	Если ЗначениеЗаполнено(ЛицоБезДоверенности) И ОбщегоНазначения.ЭтоСсылка(ТипЗначения) Тогда
		...
		Если Метаданные.ОпределяемыеТипы.ФизическоеЛицо.Тип.СодержитТип(ТипЗначения) Тогда
			...
			СброситьОформлениеЭлементовФормы(Элементы.ГруппаЛицоБезДоверенностиПередоверия_ФизическоеЛицо, Истина);
		...
		Иначе
			...
			Если ИнтеграцияЭДО.ЭтоФизЛицо(ЛицоБезДоверенности) Тогда
				...
				СброситьОформлениеЭлементовФормы(Элементы.ГруппаЛицоБезДоверенностиПередоверия_ИндивидуальныйПредприниматель, Истина);
			Иначе
				...
				СброситьОформлениеЭлементовФормы(Элементы.ГруппаЛицоБезДоверенностиПередоверия_ЮридическоеЛицо, Истина);
				
			КонецЕсли;
			
		КонецЕсли;
		
		СброситьОформлениеЭлементовФормы(Элементы.ДоверенностьДокументПередовСвПередПолнПередПолнРосОргПерПолнЛицоБезДов_ЛицоБезДоверенности);
...
Процедура ПерезаполнитьСведенияОПредставителе(Представитель)
	...
	Если ЗначениеЗаполнено(Представитель) И ОбщегоНазначения.ЭтоСсылка(ТипЗначения) Тогда
		...
		Если Метаданные.ОпределяемыеТипы.ФизическоеЛицо.Тип.СодержитТип(ТипЗначения) Тогда
			...
			КонтактнаяИнформация = ИнтеграцияБСПБЭД.КонтактнаяИнформацияОбъекта(Представитель, "Адрес");
			СведенияОФизЛице.СведФЛ[0].АдрМЖ[0].АдрРФ = КонтактнаяИнформация.Представление;
			
			СведенияОбАдресе = ИнтеграцияБСПБЭД.СведенияОбАдресеПоЗначению(КонтактнаяИнформация.Значение);
			СведенияОФизЛице.СведФЛ[0].АдрМЖ[0].Регион = СведенияОбАдресе.КодРегиона;
			
			ЗаполнитьТаблицуТипаСведФЛ(СведенияОФизЛице.СведФЛ[0], СтруктураСведений);
			ПоказатьГруппу(Элементы.ГруппаПредставительПередоверия, Элементы.ГруппаПредставительПередоверия_ФизическоеЛицо);
			СброситьОформлениеЭлементовФормы(Элементы.ГруппаПредставительПередоверия_ФизическоеЛицо, Истина);
		Иначе
			...
			Если ИнтеграцияЭДО.ЭтоФизЛицо(Представитель) Тогда
				...
				СброситьОформлениеЭлементовФормы(Элементы.ГруппаПредставительПередоверия_ИндивидуальныйПредприниматель, Истина);
			Иначе
				...
				СброситьОформлениеЭлементовФормы(Элементы.ГруппаПредставительПередоверия_Организация, Истина);
			КонецЕсли;
		КонецЕсли;
		
		СброситьОформлениеЭлементовФормы(Элементы.ДоверенностьДокументПередовСвПолучПолн_Представитель);
...
Процедура ПерезаполнитьСведенияОФизическомЛицеПередоверия(ФизическоеЛицо)
	...
	Если ЗначениеЗаполнено(ФизическоеЛицо) И ОбщегоНазначения.ЭтоСсылка(ТипЗнч(ФизическоеЛицо)) Тогда
		...
		СброситьОформлениеЭлементовФормы(Элементы.ГруппаОдноВложенноеЛицоДействующееБезДоверенностиПередоверия, Истина);
	КонецЕсли;
...
Процедура ЗаполнитьСписокРегионов()
	...
	Если СписокРегионов = Неопределено Тогда
		...
		Элементы.ДоверенностьДокументПередовСвПолучПолнПредСведФизЛСведФЛАдрМЖРегион.РежимВыбораИзСписка = Ложь;
	Иначе
		...
		Элементы.ДоверенностьДокументПередовСвПолучПолнПредСведФизЛСведФЛАдрМЖРегион.РежимВыбораИзСписка = Истина;
		...
		Для Каждого Регион Из СписокРегионов Цикл
			...
			Элементы.ДоверенностьДокументПередовСвПолучПолнПредСведФизЛСведФЛАдрМЖРегион.СписокВыбора
				.Добавить(Код, Наименование);
...
&НаКлиентеНаСервереБезКонтекста
Процедура СброситьОформлениеЭлементовФормы(Элемент, Рекурсивно = Ложь)
...
Процедура Подключаемый_СброситьОформлениеЭлемента(Элемент)
	СброситьОформлениеЭлементовФормы(Элемент);
КонецПроцедуры
...
Процедура ПерезаполнитьСведенияОРуководителеФилиалаПередоверия(ФизическоеЛицо)
	...
	Если ЗначениеЗаполнено(ФизическоеЛицо) И ОбщегоНазначения.ЭтоСсылка(ТипЗнч(ФизическоеЛицо)) Тогда
		...
		СброситьОформлениеЭлементовФормы(Элементы.ГруппаОдноЛицо_ФилиалОрганизации_Руководитель, Истина);
	КонецЕсли;
...
Процедура ПерезаполнитьСведенияОРуководителеИностраннойОрганизацииПередоверия(ФизическоеЛицо)
	...
	Если ЗначениеЗаполнено(ФизическоеЛицо) И ОбщегоНазначения.ЭтоСсылка(ТипЗнч(ФизическоеЛицо)) Тогда
		...
		СброситьОформлениеЭлементовФормы(Элементы.ГруппаОдноЛицо_ФилиалИностраннойОрганизации_Руководитель, Истина);
	КонецЕсли;
...
Процедура ПриИзмененииДаты(ИмяЭлемента)
	...
	Если ИмяЭлемента = Элементы.ДоверенностьДокументПередовСвПереДоверДатаВыдДовер.Имя
		...
		СброситьОформлениеЭлементовФормы(Элементы[ИмяЭлемента]);
	КонецЕсли;
...
//    * СтатусТранзакции        - Строка - "PENDING" - транзакция в обработке, "SUCCESS" - транзакция завершилась успешно,
//                                        "FAILURE" - ошибка при обработке транзакции, при ошибке получения
...
Процедура ОбработатьРегистрациюМЧД(Результат, Контекст) Экспорт
	...
	Если ТипЗнч(Результат) <> Тип("Структура")
		...
		Если ЗначениеЗаполнено(Результат.ОписаниеОшибкиРегистрации)
			И Не МашиночитаемыеДоверенностиКлиентСервер.РодительскаяМЧДОтсутствуетВРеестре(
				Результат.ОписаниеОшибкиРегистрации) Тогда
			Прочитать();
...
&НаКлиенте
Процедура НачатьРедактированиеТелефона(СтандартнаяОбработка, ИмяЭлемента)
		
	СтандартнаяОбработка = Ложь;
	
	Телефон = "";
	Если ИмяЭлемента = "ДоверенностьДокументПередовСвПередПолнПередПолнРосОргПерПолнСвРосОргКонтактТлф" Тогда
		Телефон = Доверенность[0].Документ[0].Передов[0].СвПередПолн[0].ПередПолн[0].РосОргПерПолн[0].СвРосОрг[0].КонтактТлф;
	ИначеЕсли ИмяЭлемента = "ДоверенностьДокументПередовСвПередПолнПередПолнФилПерПолнСвФилКонтактТлф" Тогда
		Телефон = Доверенность[0].Документ[0].Передов[0].СвПередПолн[0].ПередПолн[0].ФилПерПолн[0].СвФил[0].КонтактТлф;
	ИначеЕсли ИмяЭлемента = "ДоверенностьДокументПередовСвПередПолнПередПолнИнПерПолнСвИнОргКонтактТлф" Тогда
		Телефон = Доверенность[0].Документ[0].Передов[0].СвПередПолн[0].ПередПолн[0].ИнПерПолн[0].СвИнОрг[0].КонтактТлф;
	КонецЕсли;
		
	ОбработкаЗавершения = Новый ОписаниеОповещения("ПослеВводаНомераТелефона", ЭтотОбъект, ИмяЭлемента);
	ИнтеграцияБСПБЭДКлиент.НачатьРедактированиеТелефона(Телефон, "", ОбработкаЗавершения); 
	
КонецПроцедуры

&НаКлиенте
Процедура ПослеВводаНомераТелефона(Результат, ИмяЭлемента) Экспорт 
	...
	Если ИмяЭлемента = "ДоверенностьДокументПередовСвПередПолнПередПолнРосОргПерПолнСвРосОргКонтактТлф" Тогда
		Доверенность[0].Документ[0].Передов[0].СвПередПолн[0].ПередПолн[0].РосОргПерПолн[0].СвРосОрг[0].КонтактТлф = Результат.Представление;
	ИначеЕсли ИмяЭлемента = "ДоверенностьДокументПередовСвПередПолнПередПолнФилПерПолнСвФилКонтактТлф" Тогда
		Доверенность[0].Документ[0].Передов[0].СвПередПолн[0].ПередПолн[0].ФилПерПолн[0].СвФил[0].КонтактТлф = Результат.Представление;
	ИначеЕсли ИмяЭлемента = "ДоверенностьДокументПередовСвПередПолнПередПолнИнПерПолнСвИнОргКонтактТлф" Тогда
		Доверенность[0].Документ[0].Передов[0].СвПередПолн[0].ПередПолн[0].ИнПерПолн[0].СвИнОрг[0].КонтактТлф = Результат.Представление;
	КонецЕсли;
	
КонецПроцедуры

&НаКлиенте
Процедура НачатьРедактированиеАдресаОрганизации(ИмяЭлемента, ЗаголовокОкнаРедактирования = "")
	
	Адрес = "";
	Если ИмяЭлемента = "ДоверенностьДокументПередовСвПолучПолнПредСведФизЛСведФЛАдрМЖАдрРФ" Тогда
		Адрес = Доверенность[0].Документ[0].Передов[0].СвПолучПолн[0].Пред[0].СведФизЛ[0].СведФЛ[0].АдрМЖ[0].АдрРФ;
	ИначеЕсли ИмяЭлемента = "ДоверенностьДокументПередовСвПередПолнПередПолнРосОргПерПолнЛицоБезДовСВЮЛСвЮЛЕИОАдрРегАдрРФ" Тогда 
		Адрес = Доверенность[0].Документ[0].Передов[0].СвПередПолн[0].ПередПолн[0].РосОргПерПолн[0].ЛицоБезДов[0].СВЮЛ[0].СвЮЛЕИО[0].АдрРег[0].АдрРФ;
	ИначеЕсли ИмяЭлемента = "ДоверенностьДокументПередовСвПередПолнПередПолнФилПерПолнСвФилАдрРегАдрРФ" Тогда 
		Адрес = Доверенность[0].Документ[0].Передов[0].СвПередПолн[0].ПередПолн[0].ФилПерПолн[0].СвФил[0].АдрРег[0].АдрРФ;
	ИначеЕсли ИмяЭлемента = "ДоверенностьДокументПередовСвПередПолнПередПолнРосОргПерПолнСвРосОргАдрРегАдрРФ" Тогда
		Адрес = Доверенность[0].Документ[0].Передов[0].СвПередПолн[0].ПередПолн[0].РосОргПерПолн[0].СвРосОрг[0].АдрРег[0].АдрРФ;
	ИначеЕсли ИмяЭлемента = "ДоверенностьДокументПередовСвПередПолнПередПолнИнПерПолнСвИнОргАдрМНФактАдрРФ" Тогда
		Адрес = Доверенность[0].Документ[0].Передов[0].СвПередПолн[0].ПередПолн[0].ИнПерПолн[0].СвИнОрг[0].АдрМНФакт[0].АдрРФ;
	КонецЕсли;
	
	ОбработкаЗавершения = Новый ОписаниеОповещения("ЗакончитьРедактированиеАдресаОрганизации", ЭтотОбъект, ИмяЭлемента);
	ИнтеграцияБСПБЭДКлиент.НачатьРедактированиеАдреса(Адрес, "", ОбработкаЗавершения);
	
КонецПроцедуры

&НаКлиенте
Процедура ЗакончитьРедактированиеАдресаОрганизации(Результат, ИмяЭлемента) Экспорт
	
	Если ТипЗнч(Результат) <> Тип("Структура") Тогда
		Возврат;
	КонецЕсли;
	
	ЗакончитьРедактированиеАдресаОрганизацииНаСервере(Результат, ИмяЭлемента);
	
КонецПроцедуры

&НаСервере
Процедура ЗакончитьРедактированиеАдресаОрганизацииНаСервере(Результат, ИмяЭлемента)
	
	СведенияОбАдресе = ИнтеграцияБСПБЭД.СведенияОбАдресеПоЗначению(Результат.Значение);
	
	Если ИмяЭлемента = "ДоверенностьДокументПередовСвПолучПолнПредСведФизЛСведФЛАдрМЖАдрРФ" Тогда
		Доверенность[0].Документ[0].Передов[0].СвПолучПолн[0].Пред[0].СведФизЛ[0].СведФЛ[0].АдрМЖ[0].АдрРФ = Результат.Представление;
		Доверенность[0].Документ[0].Передов[0].СвПолучПолн[0].Пред[0].СведФизЛ[0].СведФЛ[0].АдрМЖ[0].Регион = СведенияОбАдресе.КодРегиона;
	ИначеЕсли ИмяЭлемента = "ДоверенностьДокументПередовСвПередПолнПередПолнРосОргПерПолнЛицоБезДовСВЮЛСвЮЛЕИОАдрРегАдрРФ" Тогда 
		Доверенность[0].Документ[0].Передов[0].СвПередПолн[0].ПередПолн[0].РосОргПерПолн[0].ЛицоБезДов[0].СВЮЛ[0].СвЮЛЕИО[0].АдрРег[0].АдрРФ = Результат.Представление;
		Доверенность[0].Документ[0].Передов[0].СвПередПолн[0].ПередПолн[0].РосОргПерПолн[0].ЛицоБезДов[0].СВЮЛ[0].СвЮЛЕИО[0].АдрРег[0].Регион = СведенияОбАдресе.КодРегиона;
	ИначеЕсли ИмяЭлемента = "ДоверенностьДокументПередовСвПередПолнПередПолнФилПерПолнСвФилАдрРегАдрРФ" Тогда 
		Доверенность[0].Документ[0].Передов[0].СвПередПолн[0].ПередПолн[0].ФилПерПолн[0].СвФил[0].АдрРег[0].АдрРФ = Результат.Представление;
		Доверенность[0].Документ[0].Передов[0].СвПередПолн[0].ПередПолн[0].ФилПерПолн[0].СвФил[0].АдрРег[0].Регион = СведенияОбАдресе.КодРегиона;
	ИначеЕсли ИмяЭлемента = "ДоверенностьДокументПередовСвПередПолнПередПолнРосОргПерПолнСвРосОргАдрРегАдрРФ" Тогда 
		Доверенность[0].Документ[0].Передов[0].СвПередПолн[0].ПередПолн[0].РосОргПерПолн[0].СвРосОрг[0].АдрРег[0].АдрРФ = Результат.Представление;
		Доверенность[0].Документ[0].Передов[0].СвПередПолн[0].ПередПолн[0].РосОргПерПолн[0].СвРосОрг[0].АдрРег[0].Регион = СведенияОбАдресе.КодРегиона;
	ИначеЕсли ИмяЭлемента = "ДоверенностьДокументПередовСвПередПолнПередПолнИнПерПолнСвИнОргАдрМНФактАдрРФ" Тогда
		Доверенность[0].Документ[0].Передов[0].СвПередПолн[0].ПередПолн[0].ИнПерПолн[0].СвИнОрг[0].АдрМНФакт[0].АдрРФ = Результат.Представление;
		Доверенность[0].Документ[0].Передов[0].СвПередПолн[0].ПередПолн[0].ИнПерПолн[0].СвИнОрг[0].АдрМНФакт[0].Регион = СведенияОбАдресе.КодРегиона;
	КонецЕсли;	
