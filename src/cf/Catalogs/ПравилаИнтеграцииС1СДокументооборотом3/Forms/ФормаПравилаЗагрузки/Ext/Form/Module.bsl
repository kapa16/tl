...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Зависимый Тогда
		...
		Элементы.Обновлять.Заголовок = НСтр("ru = 'обновлять (настраивается для всей таблицы)'; en = 'update (configured for the entire table)'");
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(СокращенноеНаименованиеКонфигурации) Тогда
		Заголовок = СтрШаблон(НСтр("ru = 'Правило заполнения реквизита %1'; en = '%1 attribute filling rule'"), СокращенноеНаименованиеКонфигурации);
	КонецЕсли;
