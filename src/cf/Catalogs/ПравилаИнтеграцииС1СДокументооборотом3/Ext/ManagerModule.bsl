...
Функция ЗаполнитьОбъектИСПоОбъектуXDTO(Прокси, ЗаполняемыйОбъектИС, ОбъектXDTO, ПравилоИнтеграции, Обновление = Ложь,
	...
	Для Каждого ДанныеРеквизита Из КонтекстЗаполненияПоПравилу.РеквизитыОбъектаИС Цикл
		...
		Если ЗначениеЗаполнено(ДанныеРеквизита.Таблица) Тогда
			// Реквизиты табличной части грузим в ЗаполнитьТаблицуПоПравилу.
			Продолжить;
		КонецЕсли;
		...
		ПараметрыОтбора.Вставить("Таблица", ДанныеРеквизита.Таблица);
...
Функция РеквизитыОбъектаДО(ТипОбъектаДО, ВидДокументаДОID, ПолучитьВсе, НастройкиВида = Неопределено,
	...
	Если ИнтеграцияС1СДокументооборот3.ЭтоДокументДО3(ТипОбъектаДО) Тогда
		...
		ТипСторона.Добавить("DMEmployee", НСтр("ru = 'Сотрудники'; en = 'Employees'"));
		ТипСторона.Добавить("DMCorrespondent", НСтр("ru = 'Контрагенты'; en = 'Counterparties'"));
		ТипСторона.Добавить("DMOrganization", НСтр("ru = 'Организации'; en = 'Companies'"));
		
		ТипКонтактноеЛицоСтороны = Новый СписокЗначений;
		ТипКонтактноеЛицоСтороны.Добавить("DMEmployee", НСтр("ru = 'Сотрудники'; en = 'Employees'"));
		ТипКонтактноеЛицоСтороны.Добавить("DMContactPerson", НСтр("ru = 'Контактные лица'; en = 'Contact persons'"));
		
		// Вид документа.
		ДобавитьРеквизит(Реквизиты, "documentType", НСтр("ru = 'Вид документа'; en = 'Document kind'"), "DMDocumentType", Истина, "ВидДокумента");
		
		// Общие реквизиты.
		ДобавитьРеквизит(Реквизиты, "title", НСтр("ru = 'Заголовок'; en = 'Title'"), "Строка", Истина, "Заголовок");
		ДобавитьРеквизит(Реквизиты, "summary", НСтр("ru = 'Содержание'; en = 'Content'"), "Строка",, "Содержание");
		ДобавитьРеквизит(Реквизиты, "regNumber", НСтр("ru = 'Регистрационный номер'; en = 'Registration number'"), "Строка",, "РегистрационныйНомер");
		ДобавитьРеквизит(Реквизиты, "regDate", НСтр("ru = 'Дата регистрации'; en = 'Registration date'"), "Дата",, "ДатаРегистрации");
		ДобавитьРеквизит(Реквизиты, "author", НСтр("ru = 'Подготовил'; en = 'Prepared by'"), "DMEmployee",, "Подготовил");
		ДобавитьРеквизит(Реквизиты, "subdivision", НСтр("ru = 'Подразделение'; en = 'Subdivision'"), "DMSubdivision",, "Подразделение");
		ДобавитьРеквизит(Реквизиты, "comment", НСтр("ru = 'Комментарий'; en = 'Comment'"), "Строка",, "Комментарий");
		ДобавитьРеквизит(Реквизиты, "responsible", НСтр("ru = 'Ответственный'; en = 'Responsible'"), "DMEmployee",, "Ответственный");
		ДобавитьРеквизит(Реквизиты, "deletionMark", НСтр("ru = 'Пометка удаления'; en = 'Deletion mark'"), "Булево");
		
		// Прочие реквизиты.
		Если ПолучитьВсе Или НастройкиВида.performanceDateEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "performanceDate", НСтр("ru = 'Срок исполнения'; en = 'Due date'"), "Дата",, "СрокИсполнения");
		КонецЕсли;
		Если ПолучитьВсе Или НастройкиТипа.accessLevelEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "accessLevel", НСтр("ru = 'Гриф доступа'; en = 'Access classification'"), "DMAccessLevel", Истина, "ГрифДоступа");
		КонецЕсли;
		Если ПолучитьВсе Или НастройкиТипа.activityMatterEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "activityMatter", НСтр("ru = 'Вопрос деятельности'; en = 'Activity issue'"), "DMActivityMatter", Истина, "ВопросДеятельности");
		КонецЕсли;
		Если ПолучитьВсе Или НастройкиТипа.projectsEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "project", НСтр("ru = 'Проект'; en = 'Project'"), "DMProject",, "Проект");
		КонецЕсли;
		Если ПолучитьВсе Или НастройкиТипа.foldersEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "folder", НСтр("ru = 'Папка'; en = 'Folder'"), "DMDocumentFolder", Истина, "Папка");
		КонецЕсли;
			...
			Если ИнтеграцияС1СДокументооборотБазоваяФункциональность.СвойствоУстановлено(НастройкиВида, "actionTypes") Тогда
				Для Каждого ВидДействияXDTO Из НастройкиВида.actionTypes Цикл
					ДобавитьРеквизит(
						...
						СтрШаблон(НСтр("ru = 'Состояние действия ""%1""'; en = 'State of the %1 action'"), ВидДействияXDTO.name),
						"DMDocumentStatus");
				КонецЦикла;
			Иначе
				ДобавитьРеквизит(Реквизиты, "statusApproval", НСтр("ru = 'Состояние согласования'; en = 'Approval state '"), "DMDocumentStatus");
				ДобавитьРеквизит(Реквизиты, "statusConfirmation", НСтр("ru = 'Состояние утверждения'; en = 'Confirmation state'"), "DMDocumentStatus");
				ДобавитьРеквизит(Реквизиты, "statusPerformance", НСтр("ru = 'Состояние исполнения'; en = 'Execution state'"), "DMDocumentStatus");
				ДобавитьРеквизит(Реквизиты, "statusRegistration", НСтр("ru = 'Состояние регистрации'; en = 'Registration state'"), "DMDocumentStatus");
				ДобавитьРеквизит(Реквизиты, "statusSigning", НСтр("ru = 'Состояние подписания'; en = 'Signature state'"), "DMDocumentStatus");
				Если ИнтеграцияС1СДокументооборотБазоваяФункциональность.СвойствоСуществует(
						НастройкиТипа, "statusAcquaintance") Тогда
					ДобавитьРеквизит(Реквизиты, "statusAcquaintance", НСтр("ru = 'Состояние ознакомления'; en = 'Preview state'"), "DMDocumentStatus");
				ИначеЕсли ИнтеграцияС1СДокументооборотБазоваяФункциональность.СвойствоСуществует(
						НастройкиТипа, "statusExamination") Тогда
					ДобавитьРеквизит(Реквизиты, "statusExamination", НСтр("ru = 'Состояние ознакомления'; en = 'Preview state'"), "DMDocumentStatus");
				КонецЕсли;
			КонецЕсли;
		КонецЕсли;
		...
		Если ПолучитьВсе Или (ИспользуютсяКонтрагентыИлиСтороны И ЭтоНеКорреспонденция) Тогда
			ДобавитьРеквизит(Реквизиты, "contactPerson", НСтр("ru = 'Контактное лицо'; en = 'Contact person'"), "DMContactPerson",, "КонтактноеЛицо");
		КонецЕсли;
		
		// Получатель.
		Если ПолучитьВсе Или НастройкиВида.isAPaymentRequest = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "recipient", НСтр("ru = 'Получатель'; en = 'Recipient'"), ТипСторона, Истина);
		КонецЕсли;
		
		// Табличная часть Контрагенты.
		Если ПолучитьВсе
				Или (НастройкиВида.correspondentEnabled = Истина И ЭтоНеКорреспонденция) Тогда
			ДобавитьТаблицу(Реквизиты, "correspondentRows.rows", НСтр("ru = 'Контрагенты'; en = 'Counterparties'"));
			ДобавитьРеквизитТаблицы(Реквизиты,
				"correspondentRows.rows", "correspondent", НСтр("ru = 'Контрагент'; en = 'Counterparty'"), "DMCorrespondent", Истина);
			ДобавитьРеквизитТаблицы(Реквизиты,
				"correspondentRows.rows", "contact", НСтр("ru = 'Контактное лицо'; en = 'Contact person'"), "DMContactPerson");
			ДобавитьРеквизитТаблицы(Реквизиты,
				"correspondentRows.rows",
				"signedFromTheCorrespondent", НСтр("ru = 'Подписал от контрагента'; en = 'Signed on behalf of a counterparty'"), "DMContactPerson");
		КонецЕсли;
		
		// Организация.
		Если ПолучитьВсе Или НастройкиВида.organizationEnabled = Истина Тогда
			Если НастройкиВида.isAPaymentRequest = Истина Тогда
				Заголовок = НСтр("ru = 'Плательщик'; en = 'Payer'");
			Иначе
				Заголовок = НСтр("ru = 'Организация'; en = 'Company'");
			КонецЕсли;
		...
		Если ПолучитьВсе Или НастройкиВида.externalNumberEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "externalNumber", НСтр("ru = '№ получателя'; en = 'Recipient No.'"), "Строка");
			ДобавитьРеквизит(Реквизиты, "externalDate", НСтр("ru = 'Дата получателя'; en = 'Recipient date '"), "Дата");
		КонецЕсли;
		
		// Сумма.
		Если ПолучитьВсе Или НастройкиВида.sumEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "sum", НСтр("ru = 'Сумма'; en = 'Amount'"), "Число",, "Сумма");
			ДобавитьРеквизит(Реквизиты, "VAT", НСтр("ru = 'В т.ч. НДС'; en = 'Including VAT'"), "Число",, "СуммаНДС");
			ДобавитьРеквизит(Реквизиты, "currency", НСтр("ru = 'Валюта'; en = 'Currency'"), "DMCurrency",, "Валюта");
		КонецЕсли;
		
		// Подписал от контрагента.
		Если ПолучитьВсе Или НастройкиВида.isIncoming = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "signerFromTheCorrespondent", НСтр("ru = 'Подписал'; en = 'Signed by'"), "DMContactPerson",, "ПодписалОтКонтрагента");
		КонецЕсли;
		...
		Если Показывать Тогда
			ДобавитьРеквизит(Реквизиты, "addressee", НСтр("ru = 'Адресат'; en = 'Addressee'"), ТипЗначения, Обязательный, "Адресат");
		КонецЕсли;
		...
		Если НастройкиВида.isIncoming = Истина Тогда
			Показывать = Истина;
			Заголовок = НСтр("ru = 'Способ получения'; en = 'Receipt method'");
		ИначеЕсли НастройкиВида.isOutgoing = Истина Тогда
			Показывать = Истина;
			Заголовок = НСтр("ru = 'Способ отправки'; en = 'Sending method'");
		КонецЕсли;
		Если Показывать Тогда
		...
		Если ПолучитьВсе Или НастройкиВида.isOutgoing = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "sent", НСтр("ru = 'Отправлен'; en = 'Sent'"), "Булево");
			ДобавитьРеквизит(Реквизиты, "sendDate", НСтр("ru = 'Дата отправки'; en = 'Dispatch date'"), "Дата");
		КонецЕсли;
		
		// Срок действия.
		Если ПолучитьВсе Или НастройкиВида.durationEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты,
				"beginDate", НСтр("ru = 'Дата начала действия'; en = 'Effective Date'"), "Дата",, "ДатаНачалаДействия");
			ДобавитьРеквизит(Реквизиты,
				"endDate", НСтр("ru = 'Дата окончания действия'; en = 'Expiration date'"), "Дата",, "ДатаОкончанияДействия");
			ДобавитьРеквизит(Реквизиты,
				"openEnded", НСтр("ru = 'Бессрочный'; en = 'Indefinite'"), "Булево",, "Бессрочный");
			ДобавитьРеквизит(Реквизиты,
				"prolongationProcedure", НСтр("ru = 'Порядок продления'; en = 'Extension procedure'"), "DMProlongationProcedure",, "ПорядокПродления");
		КонецЕсли;
		
		// Суммы по статьям ДДС.
		Если ПолучитьВсе Или НастройкиВида.cashFlowDetailsEnabled = Истина Тогда
			ДобавитьТаблицу(Реквизиты, "cashFlowRows.rows", НСтр("ru = 'Статьи движения денежных средств'; en = 'Cash flow items'"));
			ДобавитьРеквизитТаблицы(Реквизиты, "cashFlowRows.rows", "item", НСтр("ru = 'Статья'; en = 'Article'"), "DMCashFlowItem", Истина);
			ДобавитьРеквизитТаблицы(Реквизиты, "cashFlowRows.rows", "total", НСтр("ru = 'Сумма'; en = 'Amount'"), "Число");
			ДобавитьРеквизитТаблицы(Реквизиты, "cashFlowRows.rows", "VAT", НСтр("ru = 'Сумма НДС'; en = 'VAT amount'"), "Число");
		КонецЕсли;
		
		// Табличная часть Товары.
		Если ПолучитьВсе Или НастройкиВида.productRowsEnabled = Истина Тогда
			ДобавитьТаблицу(Реквизиты, "productRows.rows", НСтр("ru = 'Товары и услуги'; en = 'Goods and services'"));
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "product", НСтр("ru = 'Товар, услуга'; en = 'Good, service'"), "DMProduct");
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "price", НСтр("ru = 'Цена'; en = 'Price'"), "Число");
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "quantity", НСтр("ru = 'Количество'; en = 'Quantity'"), "Число");
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "measurementUnit", НСтр("ru = 'Единица измерения'; en = 'Unit of measurement'"), "DMMeasurementUnit");
			Если ИнтеграцияС1СДокументооборотБазоваяФункциональностьПовтИсп.ДоступенФункционалВерсииСервиса("3.0.16.33") Тогда
				ДобавитьРеквизитТаблицы(Реквизиты,
					"productRows.rows", "VATRateUniversal", НСтр("ru = 'Ставка НДС'; en = 'VAT rate'"), "DMVATRateUniversal");
			Иначе
				ДобавитьРеквизитТаблицы(Реквизиты,
					"productRows.rows", "VATRate", НСтр("ru = 'Ставка НДС'; en = 'VAT rate'"), "DMVATRate");
			КонецЕсли;
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "VAT", НСтр("ru = 'Сумма НДС'; en = 'VAT amount'"), "Число");
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "total", НСтр("ru = 'Сумма'; en = 'Amount'"), "Число");
		КонецЕсли;
		...
		Если ПолучитьВсе Или (НастройкиВида.partiesEnabled = Истина И НастройкиВида.isAPaymentRequest <> Истина) Тогда
			ДобавитьТаблицу(Реквизиты, "partyRows.rows", НСтр("ru = 'Стороны'; en = 'Parties'"));
			ДобавитьРеквизитТаблицы(Реквизиты,
				"partyRows.rows", "comment", НСтр("ru = 'Комментарий'; en = 'Comment'"), "Строка");
			ДобавитьРеквизитТаблицы(Реквизиты,
				"partyRows.rows", "contact", НСтр("ru = 'Контактное лицо'; en = 'Contact person'"), ТипКонтактноеЛицоСтороны);
			ДобавитьРеквизитТаблицы(Реквизиты,
				"partyRows.rows", "description", НСтр("ru = 'Наименование стороны'; en = 'Party name'"), "DMPartyName");
			ДобавитьРеквизитТаблицы(Реквизиты,
				"partyRows.rows", "party", НСтр("ru = 'Сторона'; en = 'Party'"), ТипСторона, Истина);
			ДобавитьРеквизитТаблицы(Реквизиты,
				"partyRows.rows", "setBy", НСтр("ru = 'Установил'; en = 'Installed'"), "DMEmployee");
			ДобавитьРеквизитТаблицы(Реквизиты,
				"partyRows.rows", "signatureDate", НСтр("ru = 'Дата подписи'; en = 'Signature date'"), "Дата");
			ДобавитьРеквизитТаблицы(Реквизиты,
				"partyRows.rows", "signed", НСтр("ru = 'Подписан'; en = 'Signed'"), "Булево");
			ДобавитьРеквизитТаблицы(Реквизиты,
				"partyRows.rows", "signedBy", НСтр("ru = 'Подписал'; en = 'Signed by'"), ТипКонтактноеЛицоСтороны);
		КонецЕсли;
		
	// Контрагент.
	ИначеЕсли ТипОбъектаДО = "DMCorrespondent" Тогда
		
		ДобавитьРеквизит(Реквизиты, "name", НСтр("ru = 'Наименование'; en = 'Name'"), "Строка", Истина, "Наименование");
		ДобавитьРеквизит(Реквизиты, "legalPrivatePerson", НСтр("ru = 'Вид контрагента'; en = 'Counterparty type'"), "DMLegalPrivatePerson", Истина, "ЮрФизЛицо");
		ДобавитьРеквизит(Реквизиты, "inn", НСтр("ru = 'ИНН'; en = 'TIN'"), "Строка",, "ИНН");
		ДобавитьРеквизит(Реквизиты, "kpp", НСтр("ru = 'КПП'; en = 'KPP'"), "Строка",, "КПП");
		ДобавитьРеквизит(Реквизиты, "okpo", НСтр("ru = 'Код по ОКПО'; en = 'OKPO code'"), "Строка",, "КодПоОКПО");
		ДобавитьРеквизит(Реквизиты, "comment", НСтр("ru = 'Комментарий'; en = 'Comment'"), "Строка",, "Комментарий");
		ДобавитьРеквизит(Реквизиты, "fullName", НСтр("ru = 'Полное наименование'; en = 'Full name'"), "Строка",, "НаименованиеПолное");
		ДобавитьРеквизит(Реквизиты, "privatePerson", НСтр("ru = 'Физическое лицо'; en = 'Individual'"), "DMPrivatePerson",, "ФизЛицо");
		ДобавитьРеквизит(Реквизиты, "responsible", НСтр("ru = 'Ответственный'; en = 'Responsible'"), "DMEmployee",, "Ответственный");
		ДобавитьРеквизит(Реквизиты, "deletionMark", НСтр("ru = 'Пометка удаления'; en = 'Deletion mark'"), "Булево");
	...
	ИначеЕсли ТипОбъектаДО = "DMMeeting" Тогда
		...
		ДобавитьРеквизит(Реквизиты, "name", НСтр("ru = 'Наименование'; en = 'Name'"), "Строка", Истина, "Наименование");
		ДобавитьРеквизит(Реквизиты, "type", НСтр("ru = 'Вид мероприятия'; en = 'Event type'"), "DMMeetingType", Истина, "ВидМероприятия");
		...
		Если ПолучитьВсе Или НастройкиТипа.foldersEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "folder", НСтр("ru = 'Папка'; en = 'Folder'"), "DMMeetingFolder", Истина, "Папка");
		КонецЕсли;
		
		ТипОрганизатор = Новый СписокЗначений;
		ТипОрганизатор.Добавить("DMEmployee", НСтр("ru = 'Сотрудники'; en = 'Employees'"));
		ТипОрганизатор.Добавить("DMCorrespondent", НСтр("ru = 'Контрагенты'; en = 'Counterparties'"));
		ДобавитьРеквизит(Реквизиты, "calledBy", НСтр("ru = 'Организатор'; en = 'Organizer'"), ТипОрганизатор, Истина, "Организатор");
		
		ТипПредседатель = Новый СписокЗначений;
		ТипПредседатель.Добавить("DMEmployee", НСтр("ru = 'Сотрудники'; en = 'Employees'"));
		ТипПредседатель.Добавить("DMCorrespondent", НСтр("ru = 'Контрагенты'; en = 'Counterparties'"));
		ТипПредседатель.Добавить("DMContactPerson", НСтр("ru = 'Контактные лица'; en = 'Contact persons'"));
		ДобавитьРеквизит(Реквизиты, "chairPerson", НСтр("ru = 'Председатель'; en = 'Chairperson'"), ТипПредседатель,, "Председатель");
		
		ТипСекретарь = Новый СписокЗначений;
		ТипСекретарь.Добавить("DMEmployee", НСтр("ru = 'Сотрудники'; en = 'Employees'"));
		ТипСекретарь.Добавить("DMCorrespondent", НСтр("ru = 'Контрагенты'; en = 'Counterparties'"));
		ТипСекретарь.Добавить("DMContactPerson", НСтр("ru = 'Контактные лица'; en = 'Contact persons'"));
		ДобавитьРеквизит(Реквизиты, "secretary", НСтр("ru = 'Секретарь'; en = 'Secretary'"), ТипСекретарь,, "Секретарь");
		
		ДобавитьРеквизит(Реквизиты, "comment", НСтр("ru = 'Комментарий'; en = 'Comment'"), "Строка",, "Комментарий");
		ДобавитьРеквизит(Реквизиты, "description", НСтр("ru = 'Описание мероприятия'; en = 'Event description'"), "Строка",, "Описание");
		
		ДобавитьРеквизит(Реквизиты, "startDate", НСтр("ru = 'Дата и время начала'; en = 'Date and time of beginning'"), "Дата",, "ДатаНачала");
		ДобавитьРеквизит(Реквизиты, "endDate", НСтр("ru = 'Дата и время окончания'; en = 'Date and time of completion'"), "Дата",, "ДатаОкончания");
		
		ДобавитьРеквизит(Реквизиты, "organization", НСтр("ru = 'Организация'; en = 'Company'"), "DMOrganization",, "Организация");
		ДобавитьРеквизит(Реквизиты, "place", НСтр("ru = 'Место проведения'; en = 'Location'"), "Строка",, "МестоПроведения");
		ДобавитьРеквизит(Реквизиты, "project", НСтр("ru = 'Проект'; en = 'Project'"), "DMProject",, "Проект");
		
		// Табличная часть Программа
		ДобавитьТаблицу(Реквизиты, "agenda", НСтр("ru = 'Программа'; en = 'Application'"));
		ДобавитьРеквизитТаблицы(Реквизиты, "agenda", "employee", НСтр("ru = 'Исполнитель'; en = 'Assignee'"), "DMEmployee");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "role", НСтр("ru = 'Роль исполнителя'; en = 'The role of the performer'"), "DMBusinessProcessExecutorRole");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "mainAddressingItem", НСтр("ru = 'Основной объект адресации исполнителя'; en = 'Main business object for the assignee'"), "DMMainAddressingObject");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "secondaryAddressingItem", НСтр("ru = 'Дополнительный объект адресации исполнителя'; en = 'Additional business object for the assignee'"), "DMSecondaryAddressingObject");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "number", НСтр("ru = 'Номер пункта'; en = 'Point number'"), "Число");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "description", НСтр("ru = 'Содержание'; en = 'Content'"), "Строка");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "comment", НСтр("ru = 'Комментарий'; en = 'Comment'"), "Строка");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "decisionIsNecessary", НСтр("ru = 'Требует принятия решения'; en = 'Requires a decision'"), "Булево");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "estimatedDuration", НСтр("ru = 'Время план (секунд)'; en = 'Planned time (seconds)'"), "Число");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "duration", НСтр("ru = 'Время факт (секунд)'; en = 'Actual time (seconds)'"), "Число");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "startDate", НСтр("ru = 'Дата и время начала'; en = 'Date and time of beginning'"), "Дата");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"agenda", "endDate", НСтр("ru = 'Дата и время окончания'; en = 'Date and time of completion'"), "Дата");
		
		// Табличная часть Участники
		ДобавитьТаблицу(Реквизиты, "attendees", НСтр("ru = 'Участники'; en = 'Participants'"));
		ДобавитьРеквизитТаблицы(Реквизиты,
			"attendees", "absent", НСтр("ru = 'Отсутствовал'; en = 'Absent'"), "Булево");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"attendees", "invitationStatus", НСтр("ru = 'Состояние приглашения'; en = 'Invitation state'"), "DMInvitationStatus");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"attendees", "mainAddressingObject", НСтр("ru = 'Основной объект адресации участника'; en = 'The main business object for the participant'"), "DMMainAddressingObject");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"attendees", "obligatory", НСтр("ru = 'Явка обязательна'; en = 'Attendance is compulsory'"), "Булево");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"attendees", "role", НСтр("ru = 'Роль исполнителя'; en = 'The role of the performer'"), "DMBusinessProcessExecutorRole");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"attendees", "secondaryAddressingObject", НСтр("ru = 'Дополнительный объект адресации участника'; en = 'Additional business object for the participant'"), "DMSecondaryAddressingObject");
		ДобавитьРеквизитТаблицы(Реквизиты,
			"attendees", "employee", НСтр("ru = 'Пользователь'; en = 'User'"), "DMEmployee");
		
		// Табличная часть Состояния
		ДобавитьТаблицу(Реквизиты, "statuses", НСтр("ru = 'Состояния'; en = 'State'"));
		ДобавитьРеквизитТаблицы(Реквизиты,
			"statuses", "objectID.ID", НСтр("ru = 'Состояние'; en = 'State'"), "Строка");
	...
	Если МестоВыполненияВыражения = Перечисления.МестаВыполненияВыраженийНаВстроенномЯзыке.НаСторонеИС Тогда
		...
		Если ЭтоТаблица И ТипЗнч(Результат) <> Тип("ТаблицаЗначений") Тогда
			ВызватьИсключение СтрШаблон(
				НСтр("ru = 'Для заполнения таблицы результат должен иметь тип %1'; en = 'To fill the table, the result must have the %1 type'"),
				"ТаблицаЗначений");
		КонецЕсли;
...
Процедура ПроверитьПравило(ПравилоИнтеграции) Экспорт
	...
	Если Не ЗначениеЗаполнено(ПравилоИнтеграции.ТипОбъектаДО) Тогда
		ВызватьИсключение НСтр("ru = 'Не задан тип объекта 1С:Документооборот'; en = '1C:Document Management object type is not specified'");
	КонецЕсли;
...
Функция СвязанныеПравилаИнтеграцииСуществуют(Сообщение) Экспорт
	...
	Исключение
		...
		Ответ = ИнтеграцияС1СДокументооборот3.ОписаниеОшибкиXDTO(
			НСтр("ru = 'Ошибка при поиске связанных правил интеграции'; en = 'An error occurred when looking for related integration rules'"),
...
Функция СоздатьСвязанноеПравилоИнтеграции(Сообщение) Экспорт
	...
	Исключение
		...
		Ответ = ИнтеграцияС1СДокументооборот3.ОписаниеОшибкиXDTO(
			НСтр("ru = 'Ошибка при создании правила интеграции'; en = 'An error occurred when creating an integration rule'"),
			ИнтеграцияС1СДокументооборот3.ПолучитьОписаниеОшибки(ИнформацияОбОшибке()));
...
Функция ДанныеРеквизита(РеквизитыОбъектаИС, ИмяРеквизитаОбъектаИС, ИмяТаблицыОбъектаИС, ЗаполняемыйОбъектИС)
	...
	Иначе
		Если ИмяТаблицыОбъектаИС = "" Тогда
			ВызватьИсключение СтрШаблон(
				НСтр("ru = 'В метаданных объекта ""%1"" не удалось найти реквизит с именем ""%2""'; en = 'Cannot find an attribute with the ""%2"" name in the ""%1"" object metadata'"),
				ЗаполняемыйОбъектИС,
				ИмяРеквизитаОбъектаИС);
		Иначе
			ВызватьИсключение СтрШаблон(
				НСтр("ru = 'В метаданных объекта ""%1"" не удалось найти реквизит таблицы ""%2"" с именем ""%3""'; en = 'Cannot find the ""%2"" table attribute with the ""%3"" name in the ""%1"" object metadata'"),
				ЗаполняемыйОбъектИС,
				ИмяТаблицыОбъектаИС,
				ИмяРеквизитаОбъектаИС);
		КонецЕсли;
...
Процедура ЗаполнитьРеквизитПоПравилу(Прокси, Реквизит, ПравилоРеквизита, ДанныеРеквизита, КонтекстЗаполненияПоПравилу,
	...
	ИначеЕсли ПравилоРеквизита.Вариант = ВариантРеквизит() Тогда
		...
		Если Не ПравилоРеквизита.ЭтоДополнительныйРеквизитДО Тогда
			...
			Иначе
				...
				Иначе
					ВызватьИсключение СтрШаблон(
						НСтр("ru = 'В правилах интеграции указано недопустимое имя реквизита-источника данных заполнения: %1'; en = 'Integration rules specify an invalid data source attribute name: %1'"),
	...
	ИначеЕсли ПравилоРеквизита.Вариант = ВариантВыражение() Тогда
		...
		Иначе
			ВызватьИсключение НСтр("ru = 'Не задано место выполнения выражения на встроенном языке.'; en = 'Location of executing the expression in 1C:Enterprise language is not specified.'");
...
"%3'; en = 'The expression result type in 1C:Enterprise language does not match the attribute type."
"Attribute type: %1."
...
Процедура ДобавитьДополнительныйРеквизит(Реквизиты, Представление, Тип, ДопРеквизитID, ДопРеквизитТип)
	...
	НоваяСтрока.Представление = СтрШаблон(НСтр("ru = 'Доп. реквизит: %1'; en = 'Additional attribute: %1'"), Представление);
...
Процедура ПроверитьПравилаЗаполненияРеквизитовИС(ПравилоИнтеграции, ОбъектИС, ОбъектXDTO, РеквизитыОбъектаИС,
	...
	Для Каждого Правило Из ПравилоИнтеграции.ПравилаЗаполненияРеквизитовИС Цикл
		...
		Если Правило.ЭтоТаблица Тогда
			ПредставлениеТипаРеквизитаИС = НСтр("ru = 'таблицы ИС'; en = 'IS tables'");
			
		ИначеЕсли Правило.ЭтоДополнительныйРеквизитИС Тогда
			ПредставлениеТипаРеквизитаИС = НСтр("ru = 'доп. реквизита ИС'; en = 'additional IS details'");
			
		ИначеЕсли Не ЗначениеЗаполнено(Правило.Таблица) Тогда
			ПредставлениеТипаРеквизитаИС = НСтр("ru = 'реквизита ИС'; en = 'IS attribute'");
			
		КонецЕсли;
		
		Если ЗначениеЗаполнено(Правило.Таблица) Тогда
			ПредставлениеРеквизитаИС = СтрШаблон(НСтр("ru = 'реквизита ""%1"" таблицы ИС ""%2""'; en = 'attribute ""%1"" of the ""%2"" IS table'"),
...
"Указано недопустимое имя реквизита-источника данных заполнения: %2'; en = 'Filling rule error %1 (Tab ""Receive from 1C:Document Management""):"
				...
				Если НайденныеСтроки.Количество() = 0 Тогда
					...
					Если Правило.ЭтоТаблица Тогда
						СписокОшибок.Добавить(
							СтрШаблон(
								НСтр("ru = 'Ошибка в правиле заполнения %1 (Закладка ""Получение из 1С:Документооборота""):"
"выбран вариант заполнения из несуществующей таблицы ""%2""'; en = 'Filling rule error %1 (Tab ""Receive from 1C:Document Management""):"
					...
					Иначе
						Если ЗначениеЗаполнено(Таблица) Тогда
							СписокОшибок.Добавить(
								СтрШаблон(
									НСтр("ru = 'Ошибка в правиле заполнения %1 (Закладка ""Получение из 1С:Документооборота""):"
"выбран вариант заполнения из реквизита ""%2"" несуществующей таблицы ""%3""'; en = 'Filling rule error %1 (Tab ""Receive from 1C:Document Management""):"
"filling option is selected from the ""%2"" attribute of non-existing table ""%3""'"),
						...
						Иначе
							СписокОшибок.Добавить(
								СтрШаблон(
									НСтр("ru = 'Ошибка в правиле заполнения %1 (Закладка ""Получение из 1С:Документооборота""):"
"выбран вариант заполнения из несуществующего реквизита ""%2""'; en = 'Filling rule error %1 (Tab ""Receive from 1C:Document Management""):"
			...
			Иначе // Дополнительный реквизит ДО.
				...
				Если НайденныеСтроки.Количество() = 0 Тогда
					СписокОшибок.Добавить(
						СтрШаблон(
							НСтр("ru = 'Ошибка в правиле заполнения %1 (Закладка ""Получение из 1С:Документооборота""):"
"выбран вариант заполнения из несуществующего доп. реквизита ""%2""'; en = 'Error in the %1 filling rule (Tab ""Receiving from 1C:Document Management""):"
"The filling option selected is from a non-existent additional attribute ""%2""'"),
									ПредставлениеРеквизитаИС,
									Правило.ДополнительныйРеквизитДОID));
				КонецЕсли;
...
"""%2""'; en = 'Filling rule error %1 (Tab ""Receive from 1C:Document Management""):"
