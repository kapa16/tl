...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Списочный состав ТС");
	НастройкиВарианта.Описание = НСтр("en='Report shows initial information about vehicles.';ru='Отчет отображает первоначальные сведения о транспортных средствах.'");
