...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание = 
		НСтр("en='Report provides printed form of battery working card.';ru='Отчет позволяет получить печатную форму карточки работы аккумулятора.'");
	...
	НастройкиВарианта.НастройкиДляПоиска.НаименованияПараметровИОтборов = ""
		+ НСтр("en='Battery';ru='Аккумулятор'") + Символы.ПС
	...
	НастройкиВарианта.НастройкиДляПоиска.КлючевыеСлова = ""
		...
		+ НСтр("en='battery';ru='аккумулятор'");
