...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Обороты вагонов по станции (Остатки)");
	НастройкиВарианта.Описание = НСтр("ru = 'Отчет обороты вагонов по станции (Остатки)'; en = 'Report on wagon turnover at the station (Remaining)'");
