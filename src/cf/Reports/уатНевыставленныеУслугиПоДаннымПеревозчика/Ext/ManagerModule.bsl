...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Невыставленные услуги по данным перевозчика");
	НастройкиВарианта.Описание = "Отчет предназначен для отображения невыставленных услуг по данным первозчика";
