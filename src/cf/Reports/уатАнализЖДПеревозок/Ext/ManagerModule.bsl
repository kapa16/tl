...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Анализ ЖД перевозок");
	НастройкиВарианта.Описание = НСтр("ru = 'Отчет Анализ ЖД перевозок'; en = 'Report: Analysis of Railway Transportation'");
