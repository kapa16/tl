...
Функция СведенияОВнешнейОбработке() Экспорт
    ...
    ПараметрыРегистрации.Вставить("Наименование", "Сличительная ведомость по ГСМ");
    ...
    ПараметрыРегистрации.Вставить("Информация", "Сличительная ведомость по ГСМ");
    
    // Создадим таблицу команд (подробнее смотрим ниже)
    ТаблицаКоманд = ПолучитьТаблицуКоманд();
    
    // Добавим команду в таблицу
    ДобавитьКоманду(ТаблицаКоманд, "Сличительная ведомость по ГСМ", "СличительнаяВедомостьПоГСМ", "ОткрытиеФормы", Истина, "ПечатьMXL");
