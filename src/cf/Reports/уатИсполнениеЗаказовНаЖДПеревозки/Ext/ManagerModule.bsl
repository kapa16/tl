...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Исполнение заказов на ЖД перевозки");
	НастройкиВарианта.Описание = НСтр("ru = 'Отчет Исполнение заказов на ЖД перевозки'; en = 'Report on Execution of Orders for Rail Transportation'");
