...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "План предоставления услуг");
	НастройкиВарианта.Описание = "Отчет предназначен для анализа плана предоставления услуг за определенный период.";
