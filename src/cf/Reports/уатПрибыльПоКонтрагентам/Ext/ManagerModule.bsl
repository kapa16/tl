...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание = НСтр("en='Report is intended to analyze profits from vehicle works on counterparties.';ru='Отчет предназначен для анализа прибыли от работ ТС по контрагентам.'");
