...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Авансовые отчеты");
	НастройкиВарианта.Описание = "Отчет отображает приход и расход денежных средств подотчетных лиц по статьям расходов";
