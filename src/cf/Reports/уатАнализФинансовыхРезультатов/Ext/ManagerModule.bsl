...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Анализ финансовых результатов");
	НастройкиВарианта.Описание = НСтр("en='Report provides information on the financial results.';ru='Отчет позволяет получить информацию о финансовых результатах.'");
