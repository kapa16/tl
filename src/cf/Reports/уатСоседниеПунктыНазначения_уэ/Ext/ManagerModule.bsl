...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Соседние пункты назначения");
	НастройкиВарианта.Описание = НСтр("en='Report is intended to receive neighboring destinations.';ru='Отчет предназначен для получения соседних пунктов назначения.'");
