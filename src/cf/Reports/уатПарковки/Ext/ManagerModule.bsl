...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Парковки");
	НастройкиВарианта.Описание = НСтр("en='Report provides detailed information about fines.';ru='Отчет позволяет получить детальную информацию о парковках.'");
