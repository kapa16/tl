...
Процедура ОбработкаПолученияПолейПредставления(Поля, СтандартнаяОбработка)
	...
	Поля.Добавить("ТитулОформлениеНомерПутевогоЛиста");
	Поля.Добавить("ТитулОформлениеДатаПутевогоЛиста");
...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Направление = "";
	Если ЗначениеЗаполнено(Данные.ТитулОформлениеНомерПутевогоЛиста) Тогда
		Номер = Данные.ТитулОформлениеНомерПутевогоЛиста;
	КонецЕсли;
	Если ЗначениеЗаполнено(Данные.ТитулОформлениеДатаПутевогоЛиста) Тогда
		Дата = Формат(Данные.ТитулОформлениеДатаПутевогоЛиста, "ДФ=dd.MM.yyyy");
	КонецЕсли;
