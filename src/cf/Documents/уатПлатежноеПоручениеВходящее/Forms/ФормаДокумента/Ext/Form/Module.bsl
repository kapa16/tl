...
Процедура ПриОткрытии(Отказ)
	...
	Если Объект.РасшифровкаПлатежа.Количество() = 0 Тогда
		...
		НоваяСтрока.ДатаКурса = Объект.Дата;
	КонецЕсли;
	...
	Если Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ОплатаПокупателя") Тогда
		Элементы.ФормаОперацияОплатаПокупателя.Пометка = Истина;
	ИначеЕсли Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ПрочиеРасчетыСКонтрагентами") Тогда
		Элементы.ФормаОперацияПрочиеРасчетыСКонтрагентами.Пометка = Истина;
	ИначеЕсли Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ПриходДенежныхСредствПрочее") Тогда
		Элементы.ФормаОперацияПриходДенежныхСредствПрочее.Пометка = Истина;
	ИначеЕсли Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ВозвратОтПодотчетника") Тогда
		Элементы.ФормаОперацияВозвратОтПодотчетника.Пометка = Истина;
	ИначеЕсли Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ВозвратОтПоставщика") Тогда
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	// Конец СтандартныеПодсистемы.ПодключаемыеКоманды
	Оповестить("ИзменениеПлатежноеПоручениеВходящее", Объект.Ссылка, ЭтотОбъект);
КонецПроцедуры
...
Процедура БанковскийСчетПриИзменении(Элемент)
	...
	НовСумма = уатОбщегоНазначенияТиповые_проф.ПриИзмененииЗначенияКассыБанковскогоСчета(Объект.ВалютаДокумента, 
		КурсДокумента, КратностьДокумента, Объект.Дата, Объект.СуммаДокумента, ВалютаСчета,
...
Процедура БанковскийСчетНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	УстановитьОтборПоВладельцуСчета();
...
Процедура РасшифровкаПлатежаСделкаПриИзменении(Элемент)
	...
	Если НЕ ЗначениеЗаполнено(СтрокаПлатеж.Сделка)
		ИЛИ Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ВозвратОтПоставщика") Тогда
		Возврат;
	КонецЕсли;
...
Процедура ОперацияОплатаПокупателя(Команда)
	...
	ВидОперацииПриИзменении(ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ОплатаПокупателя"));
КонецПроцедуры

&НаКлиенте
Процедура ОперацияПриходДенежныхСредствПрочее(Команда)
	Объект.ПодотчетноеЛицо = Неопределено;
	ВидОперацииПриИзменении(ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ПриходДенежныхСредствПрочее"));
КонецПроцедуры

&НаКлиенте
Процедура ОперацияПрочиеРасчетыСКонтрагентами(Команда)
	Объект.ПодотчетноеЛицо = Неопределено;
	ВидОперацииПриИзменении(ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ПрочиеРасчетыСКонтрагентами"));
КонецПроцедуры

&НаКлиенте
Процедура ОперацияВозвратОтПоставщика(Команда)
	Объект.ПодотчетноеЛицо = Неопределено;
	ВидОперацииПриИзменении(ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ВозвратОтПоставщика"));
КонецПроцедуры

&НаКлиенте
Процедура ОперацияВозвратОтПодотчетника(Команда)
	Объект.Контрагент = Неопределено;
	ВидОперацииПриИзменении(ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ВозвратОтПодотчетника"));
КонецПроцедуры
...
Процедура ВидОперацииПриИзменении(ВидОперацииЗначение)
	...
	Элементы.ФормаОперацияОплатаПокупателя.Пометка            = (Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ОплатаПокупателя"));
	Элементы.ФормаОперацияПрочиеРасчетыСКонтрагентами.Пометка = (Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ПрочиеРасчетыСКонтрагентами"));
	Элементы.ФормаОперацияПриходДенежныхСредствПрочее.Пометка = (Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ПриходДенежныхСредствПрочее"));
	Элементы.ФормаОперацияВозвратОтПоставщика.Пометка         = (Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ВозвратОтПоставщика"));
	Элементы.ФормаОперацияВозвратОтПодотчетника.Пометка       = (Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ВозвратОтПодотчетника"));
	...
	Если Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ОплатаПокупателя")
		ИЛИ Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ПрочиеРасчетыСКонтрагентами")
		ИЛИ Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ВозвратОтПоставщика") Тогда
...
Процедура ПодборПоЗадолженности(флБезРазбиения)
	...
	СтруктураПараметров.Вставить("ВидОперацииВозврат",          Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ВозвратОтПоставщика"));
...
Процедура УстановитьВидимость()
	...
	Если Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ОплатаПокупателя")
		...
		Элементы.ГруппаВидыОпераций.ТекущаяСтраница = Элементы.ГруппаВидыОпераций.ПодчиненныеЭлементы.ПКО;
		Если Булево(СпособРедактирования) Тогда
			Элементы.ГруппаПлатежей.ТекущаяСтраница = Элементы.ГруппаПлатежей.ПодчиненныеЭлементы.ПлатежПоНесколькимСделкам;
			Элементы.РасшифровкаПлатежа.Высота = 0;
			Элементы.РасшифровкаПлатежа.РастягиватьПоВертикали = Истина;
		Иначе
			Элементы.ГруппаПлатежей.ТекущаяСтраница = Элементы.ГруппаПлатежей.ПодчиненныеЭлементы.ПлатежПоОднойСделке;
		...
		Элементы.РасшифровкаПлатежаСделка1.Доступность = (Объект.ВидОперации <> ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ПрочиеРасчетыСКонтрагентами"));
		Элементы.РасшифровкаПлатежаСделка.Доступность  = (Объект.ВидОперации <> ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ПрочиеРасчетыСКонтрагентами"));
	...
	Иначе
		Элементы.ГруппаВидыОпераций.ТекущаяСтраница = Элементы.ГруппаВидыОпераций.ПодчиненныеЭлементы.Прочее;
		Элементы.СпособРедактирования.Видимость = Ложь;
		Элементы.Контрагент.Видимость = Истина;
		Элементы.ПодотчетноеЛицо.Видимость = Ложь;
		Элементы.РасшифровкаПлатежаПодборВРасшифровку.Видимость = Истина;
	...
	Элементы.ГруппаРаспределениеПоЗаказам.Видимость = РазнесениеПоЗаказам
		И (Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ОплатаПокупателя")
		ИЛИ Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ВозвратОтПоставщика"));
		
КонецПроцедуры // УстановитьВидимость()

&НаСервере
Процедура УстановитьОтборПоВладельцуСчета()
...
Процедура УстановитьОграничениеТипаСделка()
	...
	Если ВедениеВзаиморасчетов = ПредопределенноеЗначение("Перечисление.ВедениеВзаиморасчетовПоДоговорам.ПоНакладным") Тогда
		Если Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ВозвратОтПоставщика") Тогда
...
Процедура ПересчитатьСуммуНДС(ТекСтрока) 
	...
	Если МноговалютныйУчет
		И (Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ОплатаПокупателя")
		ИЛИ Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ВозвратОтПоставщика")
		ИЛИ Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийПлатежноеПоручениеВходящее.ПрочиеРасчетыСКонтрагентами")) Тогда
