...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Объект.ТребуетсяОплата Тогда
		...
		Если КоличествоФайлов > 1 Тогда
			Элементы.СохранитьФайл.Заголовок = НСтр("ru = 'Сохранить файлы'; en = 'Save the files'");
		КонецЕсли;
	Иначе
...
"Пожалуйста, пополните баланс.'; en = 'Insufficient funds on the document recognition account."
...
"Нажмите ""Отправить повторно"", чтобы отправить файлы на распознавание еще раз.'; en = 'Insufficient funds on the document recognition account. Please top up your balance."
