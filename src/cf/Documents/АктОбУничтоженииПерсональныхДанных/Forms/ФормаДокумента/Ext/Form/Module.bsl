...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Ключ.Пустая() Тогда
		...
		// {УАТ}
		ЗаполнитьНаименованиеОрганизацииДляПечати();
		// {/УАТ}
		
	КонецЕсли;
	
	// {УАТ}
	уатОбщегоНазначения.ИзменитьФормуАктаОбУничтоженииПерсональныхДанных(Элементы);
	// {/УАТ}
...
Процедура ЗаполнитьДеревоКатегорийДанных()
	...
	Для Каждого Категория Из ВсеКатегории Цикл
		...
		Если Не ПустаяСтрока(ПредставлениеКатегории) Тогда
			СтрокаКатегория = ДеревоКатегорий.Строки.Добавить();
			СтрокаКатегория.Данные = ПредставлениеКатегории;
		Иначе
			Продолжить;
		КонецЕсли;
		// {/УАТ}
...
// {УАТ}
&НаСервере
Процедура ЗаполнитьНаименованиеОрганизацииДляПечати()
	Объект.НаименованиеОрганизации = Справочники.Организации.НаименованияОрганизации(Объект.Организация).НаименованиеДляПечатныхФорм;
КонецПроцедуры
// {/УАТ}
