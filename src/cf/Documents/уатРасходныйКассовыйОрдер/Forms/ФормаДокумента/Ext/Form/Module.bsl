...
Процедура ПриОткрытии(Отказ)
	...
	Если Параметры.Ключ.Пустая() Тогда // проверить объект на то, что он еще не внесен в ИБ	
		...
		Если ПараметрыЗначениеКопирования.Пустая() И Объект.ВидОперации <> ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ВыдачаПодотчетнику") Тогда
	...
	Если Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ОплатаПоставщику") Тогда
		Элементы.ФормаОперацияОплатаПоставщику.Пометка = Истина;
	ИначеЕсли Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ПрочиеРасчетыСКонтрагентами") Тогда
		Элементы.ФормаОперацияПрочиеРасчетыСКонтрагентами.Пометка = Истина;
	ИначеЕсли Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.РасходДенежныхСредствПрочее") Тогда
		Элементы.ФормаОперацияРасходДенежныхСредствПрочее.Пометка = Истина;
	ИначеЕсли Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ВыдачаПодотчетнику") Тогда
		Элементы.ФормаОперацияВыдачаПодотчетнику.Пометка = Истина;
	ИначеЕсли Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ВозвратПокупателю") Тогда
		Элементы.ФормаОперацияВозвратПокупателю.Пометка = Истина;
	КонецЕсли;
	...
	Если ПересчитыватьСумму Тогда
		...
		Иначе
			Если ЗначениеЗаполнено(СтрокаПлатеж.ДокументПланированияПлатежа) Тогда
				ВалютаПлатежаПлан = уатОбщегоНазначенияТиповыеСервер.ПолучитьЗначениеРеквизита(СтрокаПлатеж.ДокументПланированияПлатежа, "ВалютаДокумента");
				Если Не (ВалютаПлатежаПлан = ПредопределенноеЗначение("Справочник.Валюты.ПустаяСсылка") 
					Или ВалютаПлатежаПлан = Объект.ВалютаДокумента) Тогда
...
Процедура РасшифровкаПлатежаДоговорКонтрагентаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ПрочиеРасчетыСКонтрагентами") Тогда
		мВидДоговора = ПредопределенноеЗначение("Перечисление.ВидыДоговоровКонтрагентов.Прочее");
	ИначеЕсли Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ОплатаПоставщику") Тогда
...
Процедура РасшифровкаПлатежаСделкаПриИзменении(Элемент)
	...
	Если НЕ ЗначениеЗаполнено(СтрокаПлатеж.Сделка)
		ИЛИ Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ВозвратПокупателю") Тогда
		Возврат;
	КонецЕсли;
...
&НаКлиенте
Процедура РасшифровкаПлатежаДокументПланированияПлатежаНачалоВыбора1(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	СтандартнаяОбработка = Ложь;
	ФормаВыбора = ПолучитьФорму("Документ.уатЗаявкаНаРасходованиеДС.Форма.ФормаВыбора",,Элемент);
		
	Если Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ОплатаПоставщику")
		ИЛИ Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ПрочиеРасчетыСКонтрагентами")
		ИЛИ Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ВозвратПокупателю") Тогда
...
Процедура ОперацияОплатаПоставщику(Команда)
	ВидОперацииПриИзменении(ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ОплатаПоставщику"));
КонецПроцедуры

&НаКлиенте
Процедура ОперацияПрочиеРасчетыСКонтрагентами(Команда)
	ВидОперацииПриИзменении(ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ПрочиеРасчетыСКонтрагентами"));
КонецПроцедуры

&НаКлиенте
Процедура ОперацияРасходДенежныхСредствПрочее(Команда)
	ВидОперацииПриИзменении(ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.РасходДенежныхСредствПрочее"));
КонецПроцедуры

&НаКлиенте
Процедура ОперацияВыдачаПодотчетнику(Команда)
	ВидОперацииПриИзменении(ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ВыдачаПодотчетнику"));
КонецПроцедуры

&НаКлиенте
Процедура ОперацияВозвратПокупателю(Команда)
	ВидОперацииПриИзменении(ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ВозвратПокупателю"));
КонецПроцедуры
...
Процедура ВидОперацииПриИзменении(ВидОперацииЗначение)
	...
	Элементы.ФормаОперацияОплатаПоставщику.Пометка            = (Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ОплатаПоставщику"));
	Элементы.ФормаОперацияПрочиеРасчетыСКонтрагентами.Пометка = (Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ПрочиеРасчетыСКонтрагентами"));
	Элементы.ФормаОперацияРасходДенежныхСредствПрочее.Пометка = (Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.РасходДенежныхСредствПрочее"));
	Элементы.ФормаОперацияВыдачаПодотчетнику.Пометка          = (Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ВыдачаПодотчетнику"));
	Элементы.ФормаОперацияВозвратПокупателю.Пометка           = (Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ВозвратПокупателю"));
...
Процедура ПодборПоЗадолженности(флБезРазбиения)
	...
	СтруктураПараметров.Вставить("ВидОперацииВозврат",          Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ВозвратПокупателю"));
	...
	Для Каждого ТекСтрокаЗаказ Из Объект.Заказы Цикл
		...
		Если мсвТекСтрока.Количество() > 0 Тогда
			НовСтрока = Новый Структура("ЗаказНаТС, СуммаПлатежа, СуммаВзаиморасчетов, СуммаНДС");
...
Процедура ПриИзмененииКонтрагента()
	...
	Если ТипЗнч(Объект.Контрагент) = Тип("СправочникСсылка.Контрагенты") Тогда
		...
		Объект.Выдать 	 = ?(ПустаяСтрока(КонтрагентНаименованиеПолное), КонтрагентНаименование, КонтрагентНаименованиеПолное);
...
&НаКлиенте
Процедура ПриИзмененииПодотчетногоЛица()
	
	Если ТипЗнч(Объект.ПодотчетноеЛицо) = Тип("СправочникСсылка.ФизическиеЛица") Тогда
		
		ФизическокЛицоФИО 		   = уатОбщегоНазначенияТиповыеСервер.ПолучитьЗначениеРеквизита(Объект.ПодотчетноеЛицо, "ФИО");
		ФизическокЛицоНаименование = уатОбщегоНазначенияТиповыеСервер.ПолучитьЗначениеРеквизита(Объект.ПодотчетноеЛицо, "Наименование");
		Объект.Выдать 	 		   = ?(ПустаяСтрока(ФизическокЛицоФИО), ФизическокЛицоНаименование, ФизическокЛицоФИО);
...
Процедура УстановитьВидимость()
	...
	Если Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ОплатаПоставщику")
		...
		Элементы.РасшифровкаПлатежаСделка1.Доступность =
			(Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ОплатаПоставщику")
			ИЛИ Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ВозвратПокупателю"));
	...
	Элементы.ГруппаРаспределениеПоЗаказам.Видимость = РазнесениеПоЗаказам
		И (Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ОплатаПоставщику")
		ИЛИ Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ВозвратПокупателю"));
...
Процедура ПересчитатьСуммуНДС(ТекСтрока)
	...
	Если МноговалютныйУчет
		И (Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ОплатаПоставщику")
		ИЛИ Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ВозвратПокупателю")
		ИЛИ Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ПрочиеРасчетыСКонтрагентами")) Тогда
...
Процедура УстановитьОграничениеТипаСделка()
	...
	Если ВедениеВзаиморасчетов = ПредопределенноеЗначение("Перечисление.ВедениеВзаиморасчетовПоДоговорам.ПоНакладным") Тогда
		Если Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.уатВидыОперацийРКО.ВозвратПокупателю") Тогда
	...
	ИначеЕсли ВедениеВзаиморасчетов = ПредопределенноеЗначение("Перечисление.ВедениеВзаиморасчетовПоДоговорам.ПоЗаказамНаТС") Тогда
		...
		мсвЗаказыДляОтбора = уатОбщегоНазначения_проф.ПолучитьЗаказыПоДоговору(СтрокаПлатеж.ДоговорКонтрагента);
		мсвПараметрыВыбора = Новый Массив;
...
Процедура ОтобразитьТекстПредупрежденияЗаказы()
	...
	Если ВидВзаиморасчетовПоСчетамНакладным(СтрокаПлатеж) Тогда
		Если ЗначениеЗаполнено(СтрокаПлатеж.Сделка) Тогда
			Если ТипЗнч(СтрокаПлатеж.Сделка) = Тип("ДокументСсылка.уатРемонтныйЛист") Тогда
				ТекстЗаголовка = ТекстЗаголовка + " (недоступно для Ремонтных листов)"
			Иначе
