...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// {УАТ}
	Если Параметры.Свойство("СоздатьЭстафету") Тогда
		СоздатьЭстафету = Истина;
	КонецЕсли; 
	Если Параметры.Свойство("СоздатьПереадресовку")
		И Параметры.Свойство("ПредставлениеСостояния")
		И Параметры.ПредставлениеСостояния <> "Не начат" Тогда
		СоздатьПереадресовку = Истина;
	КонецЕсли;
	// {/УАТ}
...
Процедура ПриОткрытии(Отказ)
	...
	// {УАТ}
	Если СоздатьЭстафету 
		И Элементы.ФормаСоздатьЭстафету.Видимость Тогда
		СоздатьЭстафету = Ложь;   
		СоздатьЭстафету(Неопределено);
	КонецЕсли; 
	Если СоздатьПереадресовку 
		И Элементы.ФормаСоздатьПереадресовку.Видимость Тогда
		СоздатьЭстафету = Ложь;   
		СоздатьПереадресовку(Неопределено);
	КонецЕсли;
	// {/УАТ}
КонецПроцедуры
