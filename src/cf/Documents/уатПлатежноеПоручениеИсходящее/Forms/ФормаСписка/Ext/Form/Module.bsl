...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ПравоДоступа("Редактирование", Метаданные.Документы.уатПлатежноеПоручениеИсходящее) Тогда 
...
Процедура ПриОткрытии(Отказ)
	...
	Элементы.СписокЗаказов.Видимость = уатПраваИНастройки.уатПолучитьПраваИНастройкиПользователя(
