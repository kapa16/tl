...
Процедура ДеревоТиповПометкаПриИзменении(Элемент)
	...
	Если ТекущиеДанные.Пометка Тогда
		...
		ОписаниеОповещения = Новый ОписаниеОповещения("ВопросОтключениеНесовместимыхТипов", ЭтотОбъект, ДополнительныеПараметры);
		Если НесовместимыеТипы.Количество() = 1 Тогда
			ТекстВопроса = НСтр("en='Ранее были выбран тип несовместимый с текущим. "
"Для использования выбранного типа необходимо отключить несовместимый. Отключить?';ru='Ранее были выбран тип несовместимый с текущим. "
"Для использования выбранного типа необходимо отключить несовместимый. Отключить?'");
		Иначе
			ТекстВопроса = НСтр("en='Ранее были выбраны типы несовместимые с текущим. "
"Для использования выбранного типа необходимо отключить несовместимые типы. Отключить?';ru='Ранее были выбраны типы несовместимые с текущим. "
...
Процедура СоздатьДополнительноеСведение(Команда)
	...
	Оповещение = Новый ОписаниеОповещения("СозданиеДополнительногоСвойства", ЭтотОбъект);
...
Процедура ДобавитьПредопределенныеТипы()
	...
	СтрокаПредопределенныеТипы.ПредставлениеТипа = НСтр("en='Предопределенные типы';ru='Предопределенные типы'");
...
Процедура ДобавитьДополнительныеСвойства()
	...
	СтрокаДополнительныеРеквизиты.ПредставлениеТипа = НСтр("en='Additional details';ru='Дополнительные реквизиты'");
	
	СтрокаДополнительныеСведения = ДеревоТипов.ПолучитьЭлементы().Добавить();
	СтрокаДополнительныеСведения.ПредставлениеТипа = НСтр("en='Additional information';ru='Дополнительные сведения'");
