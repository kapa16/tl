...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Отбор.Свойство("Физлицо") Тогда
		...
		УдостоверениеЛичности = ?(ЕстьУдостоверение, НСтр("en='ID:';ru='Удостоверение личности:'") + " ", "") + УдостоверениеЛичности;
		...
		Если Не ЕстьУдостоверение И ЕстьДокументы Тогда
			...
			ТекстСообщения = НСтр("en='ID document is not specified for individual %1.';ru='Для физлица %1 не задан документ, удостоверяющий личность.'");
