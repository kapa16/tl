...
Функция КлассыСущностей() Экспорт
	...
	Результат = Новый Структура;
	Для Каждого Описание Из СоответствиеКлассовСущностей() Цикл
		Результат.Вставить(Описание.Значение, Описание.Значение);
	КонецЦикла;
...
Функция СтатусДокумента(Ключ) Экспорт
	...
	Возврат СтатусыДокумента().Ошибка;
...
Функция ТипДокумента(Ключ) Экспорт
	...
	Возврат ТипыДокумента().НеопределенныйФормат;
...
Функция КлассДокумента(Ключ) Экспорт
	...
	Возврат КлассыДокумента().НеопределенныйДокумент;
...
Функция КлассСущности(Ключ) Экспорт
	...
	Результат = СоответствиеКлассовСущностей()[Ключ];
	Возврат ВыбратьИз(Результат, Ключ);
...
Функция СоответствиеКодовОшибокТексту()
	...
	Результат.Вставить(
		...
		НСтр("ru='Не поддерживаемый формат файла или поврежденное изображение.
		     ...
		     |en='Image is corrupted or is of an unsupported type.
		         |Supported file types are tiff, jpeg, png, bmp, zip, rar, 7z, pdf, xls, xlsx.'")
	);
	Результат.Вставить(
		10,
		НСтр("ru='Не удалось выполнить распознавание документа.';
		     |en='Document recognition failed.'")
	);
	Результат.Вставить(
		11,
		НСтр("ru='Не удалось определить тип распознаваемого документа.';
		     |en='Failed to recognize the document type.'")
	);
	Результат.Вставить(
		12,
		НСтр("ru='Качество изображения слишком низкое.';
		     |en='Image quality is too low.'")
	);
	Результат.Вставить(
		13,
		НСтр("ru='Качество изображения слишком низкое или изображение не является документом.';
		     |en='Image quality is too low or not an image of a document.'")
	);
	Результат.Вставить(
		20,
	...
	Результат.Вставить(
		...
		НСтр("ru='Не удалось сформировать json.';
		     |en='Failed to build JSON.'")
	);
	Результат.Вставить(
		60,
		НСтр("ru='Ошибка нетипового документа:
		         |Не удалось обработать как нетиповой документ.';
		     |en='Non-standard document error:
		         |failed to process as a non-standard document.'")
	);
	Результат.Вставить(
		61,
		НСтр("ru='Ошибка нетипового документа:
		     ...
		     |en='Non-standard document error:
		         |failed to identify the document type.'")
	);
	Результат.Вставить(
		62,
		НСтр("ru='Ошибка нетипового документа:
	...
	Результат.Вставить(
		...
		НСтр("ru='Ошибка нетипового документа:
		     ...
		     |en='Non-standard document error:
		         |failed to recognize the template.'")
	);
	Результат.Вставить(
		71,
...
Функция СоответствиеТиповДокументов()
	...
	Результат.Вставить("undefined", "НеопределенныйФормат");
...
Функция СоответствиеКлассовДокументов()
	...
	Результат.Вставить("ucd", "УКД");
	Результат.Вставить("undefined", "НеопределенныйДокумент");
...
Функция СоответствиеТиповСущностей()
	...
	Результат.Вставить("complexlist",    "Составной");
	
	Возврат Результат;
	
КонецФункции

Функция СоответствиеКлассовСущностей()
	...
	Результат.Вставить("$bank_account_number", "НомерБанковскогоСчета");
	...
	Результат.Вставить("$base_unit_description", "НаименованиеЕдиницыИзмерения");
	...
	Результат.Вставить("$corrected_document_ids", "НомераСчетовФактурКорректировки");
	Результат.Вставить("$corrected_transfer_document_ids", "НомераПередаточныхКорректировки");
	Результат.Вставить("$replaced_corrected_document_id", "НомерИсправленияКорректировкиСчетаФактуры");
	
	//Результат.Вставить("$ucd_correction_table", "ТаблицаИзмененийНоменклатур");
	Результат.Вставить("$ucd_correction_table", "ТаблицаНоменклатур");
	
	Результат.Вставить("$position", "НомерСтроки");
	Результат.Вставить("$original_position", "НомерИсходнойСтроки");
	Результат.Вставить("$price_before", "ЦенаДоКорректировки");
	Результат.Вставить("$price_after", "Цена");
	Результат.Вставить("$quantity_before", "КоличествоДоКорректировки");
	Результат.Вставить("$quantity_after", "Количество");
	Результат.Вставить("$vat_amount_before", "СуммаНДСДоКорректировки");
	Результат.Вставить("$vat_amount_after", "СуммаНДС");
	Результат.Вставить("$vat_rate_before", "СтавкаНДСДоКорректировки");
	Результат.Вставить("$vat_rate_after", "СтавкаНДС");
	Результат.Вставить("$vat_type_before", "СтавкаНДСТипДоКорректировки");
	Результат.Вставить("$vat_type_after", "СтавкаНДСТип");
	Результат.Вставить("$total_before", "СуммаДоКорректировки");
	Результат.Вставить("$total_after", "Сумма");
	Результат.Вставить("$total_excluding_vat_before", "СуммаБезНДСДоКорректировки");
	Результат.Вставить("$total_excluding_vat_after", "СуммаБезНДС");
	Результат.Вставить("$total_including_vat_before", "СуммаСНДСДоКорректировки");
	Результат.Вставить("$total_including_vat_after", "СуммаСНДС");
	Результат.Вставить("$country_of_origin_code_before", "КодСтраныПроисхожденияДоКорректировки");
	Результат.Вставить("$country_of_origin_code_after", "КодСтраныПроисхождения");
	Результат.Вставить("$country_of_origin_description_before", "НаименованиеСтраныПроисхожденияДоКорректировки");
	Результат.Вставить("$country_of_origin_description_after", "НаименованиеСтраныПроисхождения");
...
Функция СоответствиеСвойствСущностей()
	...
	Результат.Вставить("corrected_documents", "ДокументыОснованияКорректировок");
...
Функция СоответствиеПодваловТаблиц()
	...
	Результат.Вставить("$footer_total_increment", "ПодвалИтогоУвеличение"); // Содержит "Итого увеличение"
	Результат.Вставить("$footer_total_decrement", "ПодвалИтогоУменьшение"); // Содержит "Итого уменьшение"
