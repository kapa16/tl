...
// Роль участника элемента регламента.
// 
// Параметры:
...
//  ЭлементРегламента - СтрокаТаблицыЗначений, Неопределено - Элемент регламента:
// * ТипЭлементаРегламента - ПеречислениеСсылка.ТипыЭлементовРегламентаЭДО - 
// * Состояние - ПеречислениеСсылка.СостоянияСообщенийЭДО - 
// * Направление - ПеречислениеСсылка.НаправленияЭДО - 
// * Дата - Дата - 
//  СостоянияЭлементовРегламента - ТаблицаЗначений - Состояния элементов регламента:
// * ТипЭлементаРегламента - ПеречислениеСсылка.ТипыЭлементовРегламентаЭДО - 
// * Состояние - ПеречислениеСсылка.СостоянияСообщенийЭДО - 
// * Направление - ПеречислениеСсылка.НаправленияЭДО - 
// * Дата - Дата - 
// 
// Возвращаемое значение:
//  Число - Роль участника элемента регламента
//
		...
		Если ЭлементРегламента.Владелец().Колонки.Найти("Ссылка") <> Неопределено
			И ТипЗнч(ЭлементРегламента.Ссылка) = Тип("ДокументСсылка.СообщениеЭДО") Тогда
				...
				Если ТипЗнч(ИдФайл) = Тип("Строка") Тогда		
					...
					Если ТипЗнч(ИдентификаторОрганизации) = Тип("Строка") Тогда
						ИдентификаторОрганизации = ВРег(ИдентификаторОрганизации);
					КонецЕсли;
