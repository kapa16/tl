...
Процедура ОпределитьРазделыСДополнительнымиОбработками(Разделы) Экспорт
	...
	уатДополнительныеОтчетыИОбработки.ОпределитьРазделыСДополнительнымиОбработками(Разделы);
	...
	Если уатОбщегоНазначенияПовтИсп.ВариантПоставкиКОРП()
		...
		// ЦСМ +++
		Разделы.Добавить(Метаданные.Подсистемы.ItobСпутниковыйМониторинг);
		// ЦСМ ---
	КонецЕсли;
	// {/УАТ}
...
Процедура ОпределитьРазделыСДополнительнымиОтчетами(Разделы) Экспорт
	...
	// {УАТ}
	Разделы.Добавить(Метаданные.Подсистемы.НСИ);
	уатДополнительныеОтчетыИОбработки.ОпределитьРазделыСДополнительнымиОтчетами(Разделы);
