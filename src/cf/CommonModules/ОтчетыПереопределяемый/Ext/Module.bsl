...
//	Команда.Заголовок = НСтр("ru = 'Моя команда...'; en = 'My team...'");
//	
...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	// {УАТ}
	уатМодификацияКонфигурацииПереопределяемый.ПриСозданииНаСервереФормыОтчета(Форма, Отказ, СтандартнаяОбработка);
	// {/УАТ}
...
//     СвойстваНастройки.ЗначенияДляВыбора.Добавить(10000000, НСтр("ru = 'Больше 10 Мб'; en = 'More than 10 MB'"));
//   КонецЕсли;
//
