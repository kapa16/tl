...
Процедура ПриОпределенииНастроек(Настройки) Экспорт
	...
	Если уатОбщегоНазначенияПовтИсп.ВариантПоставкиПРОФ()
		...
		ИменаУдаляемыхДокументов = Новый Массив;
		ИменаУдаляемыхДокументов.Добавить("Документ.уатАктОтгрузки_уэ");
		ИменаУдаляемыхДокументов.Добавить("Документ.уатАктПриемки_уэ");
		ИменаУдаляемыхДокументов.Добавить("Документ.уатПотребностьВПеревозке_уэ");
		ИменаУдаляемыхДокументов.Добавить("Документ.уатРассылкаЭлектронныхПисем_уэ");

		Для Каждого ИмяДокумента Из ИменаУдаляемыхДокументов Цикл
			СтруктураОтбора = Новый Структура("Имя", ИмяДокумента);
			НайденныеСтроки = Настройки.ПредметыШаблонов.НайтиСтроки(СтруктураОтбора);
			Для Каждого ТекСтрока Из НайденныеСтроки Цикл
				Настройки.ПредметыШаблонов.Удалить(ТекСтрока);
			КонецЦикла;
		КонецЦикла;
	...
	Если НЕ уатОбщегоНазначенияПовтИсп.ВариантПоставкиТакси() Тогда
		ИменаУдаляемыхДокументов = Новый Массив;
		ИменаУдаляемыхДокументов.Добавить("Документ.такЗаказТакси"); 
		ИменаУдаляемыхДокументов.Добавить("Документ.такАрендаТС");
		Для Каждого ИмяДокумента Из ИменаУдаляемыхДокументов Цикл
			СтруктураОтбора = Новый Структура("Имя", ИмяДокумента);
			НайденныеСтроки = Настройки.ПредметыШаблонов.НайтиСтроки(СтруктураОтбора);
			Для Каждого ТекСтрока Из НайденныеСтроки Цикл
