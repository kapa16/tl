	...
	Исключение
		...
		СообщениеОбОшибке = СообщениеОбОшибке + " " + СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Невозможно вывести в печатную форму область ""%1"" из макета.';
				|en = 'Cannot output area ""%1"" from the template into the print form.'"),
		...
		Если ЗадаватьВопрос Тогда
			Если СохраненныеНаименования.Количество() = 1 Тогда
				...
				ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'По документу ранее уже была сформирована основная печатная форма ""%1"", пользователь ""%2"", дата формирования ""%3"". Заменить сохраненную основную печатную форму для документа?';
						|en = 'A default print form for this document has already been generated: %1, by %2, on %3. Replace the default print form for this document?'"),
			...
			Иначе
				ТекстВопроса = НСтр("ru = 'По одному или нескольким из выбранных документов уже печаталась основная форма. Заменить сохраненную основную печатную форму для документов?';
									|en = 'A default print form has already been generated for one or more of the selected documents. Replace the default print form for these documents?'");
			КонецЕсли;
		КонецЕсли;
