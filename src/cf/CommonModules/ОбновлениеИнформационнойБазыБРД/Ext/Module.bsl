...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Имя = "БиблиотекаРаспознаванияДокументов";
	Описание.Версия = РаспознаваниеДокументов.ВерсияБиблиотеки();
	Описание.ИдентификаторИнтернетПоддержки = "OCR";
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Версия = "1.4.1.8";
	Обработчик.Процедура = "РаспознаваниеДокументовСлужебный.ВключениеРаспознаванияДокументов";
	Обработчик.РежимВыполнения = "Оперативно";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.4.6.1";
	Обработчик.Процедура = "РаспознаваниеДокументовСлужебный.ОбновлениеРаспознанныхДокументов";
	Обработчик.РежимВыполнения = "Оперативно";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.4.7.2";
	Обработчик.Процедура = "РаспознаваниеДокументовСлужебный.ОбновлениеНастроекРаспознаванияДокументов";
	Обработчик.РежимВыполнения = "Оперативно";
