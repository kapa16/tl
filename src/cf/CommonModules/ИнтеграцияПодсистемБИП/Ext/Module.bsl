...
Процедура ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.ПолучениеОбновленийПрограммы") Тогда
		...
		МодульПолучениеОбновленийПрограммы.ПараметрыРаботыКлиентаПриЗапуске(ПараметрыИПП, Параметры);
	КонецЕсли;
...
// См. ИнтернетЭквайрингПереопределяемый.ПриОпределенииОрганизации
//  
Процедура ПриОпределенииОрганизацииЭквайринг(
		Организация,
		ПрикладныеНастройки,
		ОтключитьЛогикуБИП) Экспорт
	
	Если ИнтеграцияПодсистемБИППовтИсп.ПодпискиБСП().ПриОпределенииОрганизацииЭквайринг Тогда
		МодульИнтеграцияПодсистемБСП = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияПодсистемБСП");
		МодульИнтеграцияПодсистемБСП.ПриОпределенииОрганизацииЭквайринг(
			Организация,
			ПрикладныеНастройки,
			ОтключитьЛогикуБИП);
	КонецЕсли;
...
// См. ОнлайнЗаказыПереопределяемый.ПриНастройкеВнешнегоВида.
//
Процедура ПриНастройкеВнешнегоВида(Организация, НастройкиСтраницы) Экспорт
	
	Если ИнтеграцияПодсистемБИППовтИсп.ПодпискиБСП().ПриНастройкеВнешнегоВида Тогда
		МодульИнтеграцияПодсистемБСП = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияПодсистемБСП");
		МодульИнтеграцияПодсистемБСП.ПриНастройкеВнешнегоВида(Организация, НастройкиСтраницы);
	КонецЕсли;
...
#Область ПроверкаКонтрагента

// См. ПроверкаКонтрагентаПереопределяемый.ПриСозданииНаСервере.
//
Процедура ПриСозданииНаСервереПроверкаКонтрагента(Форма, Настройки) Экспорт
	
	Если ИнтеграцияПодсистемБИППовтИсп.ПодпискиБСП().ПриСозданииНаСервереПроверкаКонтрагента Тогда
		МодульИнтеграцияПодсистемБСП = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияПодсистемБСП");
		МодульИнтеграцияПодсистемБСП.ПриСозданииНаСервереПроверкаКонтрагента(
			Настройки);
	КонецЕсли;
...
//
Процедура ПриОпределенииНастроекПодключенияКПлатежнойСистеме(ПараметрыНастройки, Настройки) Экспорт
	
	Если ИнтеграцияПодсистемБИППовтИсп.ПодпискиБСП().ПриОпределенииНастроекПодключенияКПлатежнойСистеме Тогда
		МодульИнтеграцияПодсистемБСП = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияПодсистемБСП");
		МодульИнтеграцияПодсистемБСП.ПриОпределенииНастроекПодключенияКПлатежнойСистеме(ПараметрыНастройки, Настройки);
	КонецЕсли;
...
//
Процедура ПриНастройкеЭлементовФормыПодключенияКПлатежнойСистеме(
	ПараметрыНастройки,
	НастройкиФормы,
	ДополнительныеПараметры) Экспорт
	
	Если ИнтеграцияПодсистемБИППовтИсп.ПодпискиБСП().ПриНастройкеЭлементовФормыПодключенияКПлатежнойСистеме Тогда
		МодульИнтеграцияПодсистемБСП = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияПодсистемБСП");
		МодульИнтеграцияПодсистемБСП.ПриНастройкеЭлементовФормыПодключенияКПлатежнойСистеме(
			ПараметрыНастройки,
			НастройкиФормы,
			ДополнительныеПараметры);
	КонецЕсли;
...
//
Процедура ПриЗаполненииФормыНастройкиПодключенияКПлатежнойСистеме(
	ПараметрыНастройки,
	НастройкиФормы,
	ДополнительныеПараметры) Экспорт
	
	Если ИнтеграцияПодсистемБИППовтИсп.ПодпискиБСП().ПриЗаполненииФормыНастройкиПодключенияКПлатежнойСистеме Тогда
		МодульИнтеграцияПодсистемБСП = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияПодсистемБСП");
		МодульИнтеграцияПодсистемБСП.ПриЗаполненииФормыНастройкиПодключенияКПлатежнойСистеме(
			ПараметрыНастройки,
			НастройкиФормы,
			ДополнительныеПараметры);
	КонецЕсли;
...
// См. ПлатежныеСистемыПереопределяемый.ПриЗаписиНастроекПодключения
//
Процедура ПриЗаписиНастроекПодключенияКПлатежнойСистеме(
	ПараметрыНастройки,
	НастройкиОплаты,
	Отказ,
	СообщениеОбОшибке) Экспорт
	
	Если ИнтеграцияПодсистемБИППовтИсп.ПодпискиБСП().ПриЗаписиНастроекПодключенияКПлатежнойСистеме Тогда
		МодульИнтеграцияПодсистемБСП = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияПодсистемБСП");
		МодульИнтеграцияПодсистемБСП.ПриЗаписиНастроекПодключенияКПлатежнойСистеме(
			ПараметрыНастройки,
			НастройкиОплаты,
			Отказ,
			СообщениеОбОшибке);
...
// См. ПлатежныеСистемыПереопределяемый.ПриОпределенииОрганизации
//  
Процедура ПриОпределенииОрганизацииПлатежныхСистем(
		ПлатежнаяСистема,
		Организация,
		ПрикладныеНастройки,
		ОтключитьЛогикуБИП) Экспорт
	
	Если ИнтеграцияПодсистемБИППовтИсп.ПодпискиБСП().ПриОпределенииОрганизацииПлатежныхСистем Тогда
		МодульИнтеграцияПодсистемБСП = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияПодсистемБСП");
		МодульИнтеграцияПодсистемБСП.ПриОпределенииОрганизацииПлатежныхСистем(
			Организация,
			ПрикладныеНастройки,
			ОтключитьЛогикуБИП);
	КонецЕсли;
...
// См. ОзонПэйПереопределяемый.ПриФормированииЗаказаНаВозврат
//
Процедура ПриФормированииЗаказаНаВозвратОзонПэй(
	ДокументОперации,
	ЗаказНаВозврат,
	НастройкаПодключения,
	ДополнительныеПараметры) Экспорт
	
	Если ИнтеграцияПодсистемБИППовтИсп.ПодпискиБСП().ПриФормированииЗаказаНаВозвратОзонПэй Тогда
		МодульИнтеграцияПодсистемБСП = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияПодсистемБСП");
		МодульИнтеграцияПодсистемБСП.ПриФормированииЗаказаНаВозвратОзонПэй(
			ДокументОперации,
			ЗаказНаВозврат,
			НастройкаПодключения,
			ДополнительныеПараметры);
...
Функция СобытияБИП() Экспорт
	...
	// ОнлайнЗаказы
	События.Вставить("ПриНастройкеВнешнегоВида", Ложь);
	...
	События.Вставить("ПриСозданииНаСервереПроверкаКонтрагента", Ложь);
	...
	События.Вставить("ПриОпределенииОрганизацииЭквайринг", Ложь);

	// Платежные системы
	События.Вставить("ПриОпределенииНастроекПодключенияКПлатежнойСистеме", Ложь);
	События.Вставить("ПриНастройкеЭлементовФормыПодключенияКПлатежнойСистеме", Ложь);
	События.Вставить("ПриЗаполненииФормыНастройкиПодключенияКПлатежнойСистеме", Ложь);
	События.Вставить("ПриЗаписиНастроекПодключенияКПлатежнойСистеме", Ложь);
	События.Вставить("ПриОпределенииОрганизацииПлатежныхСистем", Ложь);
	
	// Платежная система Озон Пэй
	События.Вставить("ПриФормированииЗаказаНаВозвратОзонПэй", Ложь);
