...
// - см. ЭлектронныеДокументыЭДО.СтандартныеТипыДокументов
//
...
// Возвращает данные по учетным записям ЭДО организации
//
// Параметры:
...
Функция ДанныеУчетныхЗаписейЭДООрганизации(Организация) Экспорт
	...
	Возврат УчетныеЗаписиЭДО.ДанныеУчетныхЗаписейЭДООрганизации(Организация);
...
// Возвращает доступные для формирования форматы электронных документов по объекту учета.
// 
// Параметры:
...
// * Приоритет - Число
// * ВыбранПоУмолчанию - Булево
Функция ДоступныеФорматыЭлектронныхДокументов(ОбъектУчета) Экспорт
	
	Возврат ЭлектронныеДокументыЭДО.ДоступныеФорматыЭлектронныхДокументовПоОбъектуУчета(ОбъектУчета);
	
КонецФункции

// Возвращает информацию о необходимости сформировать счет-фактуру для объекта учета по настройкам ЭДО с контрагентом.
// 
// Параметры:
//  ОбъектУчета - ОпределяемыйТип.ОснованияЭлектронныхДокументовДокументОбъектЭДО
// 
...
Функция ТребуетсяФормированиеСчетаФактурыПоОбъектуУчета(ОбъектУчета) Экспорт
	...
	Возврат ИнтеграцияЭДО.ТребуетсяФормированиеСчетаФактурыПоОбъектуУчета(ОбъектУчета);
	
КонецФункции

// Изменяет формат в настройках отправки электронных документов по заданному идентификатору формата,
// настройки отправки получает по объекту учета.
// 
// Параметры:
//  ОбъектУчета - ОпределяемыйТип.ОснованияЭлектронныхДокументовДокументОбъектЭДО
//  ИдентификаторФормата - Строка
// 
// Возвращаемое значение:
//  Булево - формат изменен.
Функция ИзменитьФорматВНастройкахОтправкиЭлектронныхДокументов(ОбъектУчета, ИдентификаторФормата) Экспорт
	
	Возврат ЭлектронныеДокументыЭДО.ИзменитьФорматВНастройкахОтправкиЭлектронныхДокументов(ОбъектУчета,
		ИдентификаторФормата);
		
КонецФункции

// Возвращает путь к форме текущих дел ЭДО в зависимости от пользовательских настроек 
// и переопределения учетной системой.
// 
// Возвращаемое значение:
//  Строка
Функция ПутьКФормеТекущихДелЭДО() Экспорт
	Возврат ИнтерфейсДокументовЭДО.ПутьКФормеТекущихДелЭДО();
КонецФункции
...
// Возвращаемое значение:
//  Строка
Функция ПутьКФормеПросмотраЭлектронногоДокумента(ЭтоВходящийЭДО = Ложь) Экспорт
	Возврат ИнтерфейсДокументовЭДО.ПутьКФормеПросмотраЭлектронногоДокумента(ЭтоВходящийЭДО);
КонецФункции
...
// Возвращаемое значение:
//  Структура:
//  * ПараметрыКомандЭДО - См. ПодключаемыеКомандыЭДО.ПараметрыРазместитьНаФормеКомандыЭДОЛегкогоИнтерфейса
//  * ДокументСсылка - Неопределено,ОпределяемыйТип.ОснованияЭлектронныхДокументовЭДО
Функция ПараметрыПриСозданииНаСервере_ФормаДокумента_ЛегкийКлиентЭДО() Экспорт
	
	Возврат ЛегкийИнтерфейсДокументовЭДО.ПараметрыПриСозданииНаСервере_ФормаДокумента();
	
КонецФункции

// Возвращает информацию о доступности внесения изменений в данные электронного документа по его состоянию ЭДО
// для связанных объектов учета.
//
// Параметры:
...
Функция ДоступноВнесениеИзмененийВДанныеЭлектронногоДокументаПоОбъектамУчета(ОбъектыУчета) Экспорт
	...
	Возврат ИнтеграцияЭДО.ДоступноВнесениеИзмененийВДанныеЭлектронногоДокументаПоВсемОбъектамУчета(ОбъектыУчета);
...
//
Функция АктуальныеЭлектронныеДокументы(ОбъектыУчета) Экспорт
	
	Возврат ИнтеграцияЭДО.АктуальныеЭлектронныеДокументы(ОбъектыУчета);
	
КонецФункции

#Область ИнтерфейсДокументовЭДО

// Новое дополнительное состояние электронного документа.
// 
// Возвращаемое значение:
//  Структура:
...
Функция НовоеДополнительноеСостояние() Экспорт
	...
	Возврат ЛегкийИнтерфейсДокументовЭДО.НовоеДополнительноеСостояние();
	
КонецФункции

// Цвета панели состояния в карточках электронных документов.
// 
// Возвращаемое значение:
//  Структура:
// * Зеленый - Цвет
...
Функция ЦветаПанельСостояния() Экспорт
	...
	Возврат ЛегкийИнтерфейсДокументовЭДО.ЦветаПанельСостояния();
...
//
// Параметры:
//  ПараметрыПриСозданииНаСервере - См. ПараметрыПриСозданииНаСервере_ФормаДокумента_ЛегкийКлиентЭДО
//
Процедура ПриСозданииНаСервере_ФормаДокумента_ЛегкийКлиентЭДО(ПараметрыПриСозданииНаСервере) Экспорт
	
	ЛегкийИнтерфейсДокументовЭДО.ПриСозданииНаСервере_ФормаДокумента(ПараметрыПриСозданииНаСервере);
	
КонецПроцедуры

#КонецЕсли // ВнешнееСоединение

#КонецОбласти // КлиентЭДО

// СтандартныеПодсистемыДокументооборота.ОбменСКонтрагентамиПоЭДО

// В исходящем формализованном документе ЭДО перезаполняет поля данных участников ЭДО
// 
// Параметры:
...
// Возвращаемое значение:
//  Структура:
//    * ДокументОбработан - Булево - Процедура заполнения данных прошла успешно
//    * ОшибкиЗаполнения - Массив Из Строка - Ошибки, возникшие при заполнении документа
//
Функция ПереформироватьДокументСогласноНастройкамОтправки(ДокументЭДО) Экспорт
	
	Результат = Новый Структура;
	Результат.Вставить("ДокументОбработан", Ложь);
	Результат.Вставить("ОшибкиЗаполнения", Новый Массив());
	
	Состояние = ЭлектронныеДокументыЭДО.СостояниеДокумента(ДокументЭДО);
	Если Состояние <> Перечисления.СостоянияДокументовЭДО.ТребуетсяПодписание Тогда
		ТекстОшибки = СтрШаблон(
			НСтр("ru = 'Заполнение участников ЭДО доступно только для документов находящихся в состоянии ""%1"", а документ находится в состоянии ""%2""'"),
			Перечисления.СостоянияДокументовЭДО.ТребуетсяПодписание, Состояние);
		Результат.ОшибкиЗаполнения.Добавить(ТекстОшибки);
		Возврат Результат;
	КонецЕсли;
	
	ДанныеУчастниковЭДО = ФорматыЭДО.НовыеДанныеУчастниковЭДО();
	...
	ДанныеОператора = СинхронизацияЭДО.СведенияОбОператоре(РеквизитыДокумента.ИдентификаторОрганизации);
	
	ДанныеУчастниковЭДО.ИдентификаторОтправителя = РеквизитыДокумента.ИдентификаторОрганизации;
	ДанныеУчастниковЭДО.ИдентификаторПолучателя = РеквизитыДокумента.ИдентификаторКонтрагента;
	
	ДанныеУчастниковЭДО.ДанныеОператораЭДО.Наименование = ДанныеОператора.Наименование;
	ДанныеУчастниковЭДО.ДанныеОператораЭДО.ИНН = ДанныеОператора.ИНН;
	ДанныеУчастниковЭДО.ДанныеОператораЭДО.Идентификатор = ДанныеОператора.Идентификатор;
	...
	Если Не РаботаСФайламиБЭДКлиентСервер.ЭтоXML(ДанныеФайла.Расширение) Тогда
		Результат.ДокументОбработан = Истина;
		Возврат Результат;
	КонецЕсли;
	
	ДвоичныеДанные = РаботаСФайлами.ДвоичныеДанныеФайла(ОсновнойФайл);
	
	ОписаниеФайла = РаботаСФайламиБЭД.НовоеОписаниеФайла();
	ОписаниеФайла.ИмяФайла = ДанныеФайла.ИмяФайла;
	ОписаниеФайла.ДвоичныеДанные = ДвоичныеДанные;
	
	ЗаполненныйФайл = ФорматыЭДО.ЗаполнитьДанныеУчастниковЭДО(ОписаниеФайла, ДанныеУчастниковЭДО);
	
	Если Не РаботаСФайламиБЭД.ХешиФайловОтличаются(ОписаниеФайла, ЗаполненныйФайл) Тогда
		Результат.ДокументОбработан = Истина;
		Возврат Результат;
	КонецЕсли;
	
	СтруктураИмени = ОбщегоНазначенияКлиентСервер.РазложитьПолноеИмяФайла(ЗаполненныйФайл.ИмяФайла);
	
	АдресДанныхДляОбновления = ПоместитьВоВременноеХранилище(ЗаполненныйФайл.ДвоичныеДанные);
	ИнформацияОФайле = Новый Структура;
	ИнформацияОФайле.Вставить("АдресФайлаВоВременномХранилище", АдресДанныхДляОбновления);
	ИнформацияОФайле.Вставить("АдресВременногоХранилищаТекста", "");
	ИнформацияОФайле.Вставить("ИмяБезРасширения", СтруктураИмени.ИмяБезРасширения);
	ИнформацияОФайле.Вставить("Расширение", ОбщегоНазначенияКлиентСервер.РасширениеБезТочки(СтруктураИмени.Расширение));
	
	НачатьТранзакцию();
	Попытка
		
		РаботаСФайлами.ОбновитьФайл(ОсновнойФайл, ИнформацияОФайле);
		
		ФайлОбъект = ОсновнойФайл.ПолучитьОбъект();
		ФайлОбъект.ПолноеИмяФайла = ЗаполненныйФайл.ИмяФайла;
		ФайлОбъект.Записать();
	...
	Исключение
		...
		ТекстСообщения = СтрШаблон(НСтр("ru = 'Не удалось обновить данные файла при переформировании по отправке:
...
// Текущие настройки отражения в учете
//
// Параметры:
...
//
Функция ТекущиеНастройкиОтраженияВУчете(Организация, Контрагент, ИдентификаторКонтрагента,
	НеПроверять=Истина) Экспорт
	...
	Возврат РезультатыЗапроса.Выбрать();
