...
//   	Реквизит.Предупреждение = НСтр("ru = 'Поле не рекомендуется менять, если уже есть введенные документы'; en = 'It is not recommended to change this field if there are already entered documents.'");
...
Процедура ПриОпределенииОбъектовСЗаблокированнымиРеквизитами(Объекты) Экспорт
	...
	// {УАТ}
	уатЗапретРедактированияРеквизитовОбъектов.ПриОпределенииОбъектовСЗаблокированнымиРеквизитами(Объекты);
	// {/УАТ}
