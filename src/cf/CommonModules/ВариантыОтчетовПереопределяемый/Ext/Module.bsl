...
//
// Пример:
//	Настройки.Поиск.ПодсказкаВвода = НСтр("ru = 'Например, себестоимость'; en = 'For example, cost price'");
...
//
// Пример:
//	Разделы.Добавить(Метаданные.Подсистемы.Анкетирование, НСтр("ru = 'Отчеты по анкетированию'; en = 'Questionnaire reports'"));
//	Разделы.Добавить(ВариантыОтчетовКлиентСервер.ИдентификаторНачальнойСтраницы(), НСтр("ru = 'Основные отчеты'; en = 'Main reports'"));
//
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	
	// {УАТ}
	Разделы.Добавить(Метаданные.Подсистемы.НСИ, НСтр("en='Reference information reports';ru='Отчеты по НСИ'"));
	уатВариантыОтчетов.ОпределитьРазделыСВариантамиОтчетов(Разделы);
	...
	Если уатОбщегоНазначенияПовтИсп.ВариантПоставкиКОРП()
		...
		// ЦСМ +++
		МодульItobВариантыОтчетов = ОбщегоНазначения.ОбщийМодуль("ItobВариантыОтчетов");
		МодульItobВариантыОтчетов.ОпределитьРазделыСВариантамиОтчетов(Разделы);
		// ЦСМ ---
	КонецЕсли;
	// {/УАТ}
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	// {УАТ}
	уатВариантыОтчетов.НастроитьВариантыОтчетов(Настройки);
	...
	Если уатОбщегоНазначенияПовтИсп.ВариантПоставкиКОРП() 
		...
		// ЦСМ +++
		МодульItobВариантыОтчетов = ОбщегоНазначения.ОбщийМодуль("ItobВариантыОтчетов");
		МодульItobВариантыОтчетов.НастроитьВариантыОтчетов(Настройки);
		// ЦСМ ---
	КонецЕсли;
	// {/УАТ}
...
Процедура ЗарегистрироватьИзмененияКлючейВариантовОтчетов(Изменения) Экспорт
	...
	Если уатОбщегоНазначенияПовтИсп.ВариантПоставкиКОРП() 
		...
		// ЦСМ +++
		МодульItobВариантыОтчетов = ОбщегоНазначения.ОбщийМодуль("ItobВариантыОтчетов");
		МодульItobВариантыОтчетов.ЗарегистрироватьИзмененияКлючейВариантовОтчетов(Изменения);
		// ЦСМ ---
	КонецЕсли;
	// {/УАТ}
...
Процедура ОпределитьОбъектыСКомандамиОтчетов(Объекты) Экспорт
	...
	// {УАТ}
	уатВариантыОтчетов.ОпределитьОбъектыСКомандамиОтчетов(Объекты);
	// {/УАТ}
