...
Процедура ОтправитьЗамерыВремени() Экспорт 
	...
	Попытка
		ФоновыеЗадания.Выполнить(
			...
			Параметры,
			КлючЗадания,
			НСтр("ru = 'Отправка замеров времени распознавания документов.'; en = 'Send document recognition time measurements.'")
		);
	Исключение
...
"%1"
"Описание ошибки:"
"%2'; en = 'Cannot send document recognition time measurements"
"%1"
"Error details:"
"%2'"),
			КлючЗадания,
