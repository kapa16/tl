...
Процедура ПослеОбновленияИнформационнойБазы(Знач ПредыдущаяВерсия, Знач ТекущаяВерсия,
	...
	// {УАТ}
	ОбщегоНазначения.ХранилищеОбщихНастроекУдалить("ПерсонализированныеПредложенияСервисов", "ЗакрытыеПользователемБаннеры", Неопределено);
	// {/УАТ}
...
Функция ПакетыСтраниц(НосительМакетов) Экспорт
	...
	Для НомерСтроки = 3 По ТабличныйДокумент.ВысотаТаблицы Цикл
		...
		// {УАТ}
		Если СтрокаТаблицы.ИмяМакета = "start" И уатОбщегоНазначенияПовтИсп.ВариантПоставкиКОРП() Тогда
			СтрокаТаблицы.ИмяФайлаСтартовойСтраницы = "start_corp.htm";
		ИначеЕсли СтрокаТаблицы.ИмяМакета = "start" И уатОбщегоНазначенияПовтИсп.ВариантПоставкиТакси() Тогда
			СтрокаТаблицы.ИмяФайлаСтартовойСтраницы = "start_prof.htm";
		ИначеЕсли СтрокаТаблицы.ИмяМакета = "start" И уатОбщегоНазначенияПовтИсп.ВариантПоставкиПРОФ() Тогда
			СтрокаТаблицы.ИмяФайлаСтартовойСтраницы = "start_prof.htm";
		ИначеЕсли СтрокаТаблицы.ИмяМакета = "start" И уатОбщегоНазначенияПовтИсп.ВариантПоставкиСТД() Тогда
			СтрокаТаблицы.ИмяФайлаСтартовойСтраницы = "start_std.htm";
		КонецЕсли;
		// {/УАТ}
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Информация при запуске';
				|en = 'Startup notifications'", ОбщегоНазначения.КодОсновногоЯзыка()),
