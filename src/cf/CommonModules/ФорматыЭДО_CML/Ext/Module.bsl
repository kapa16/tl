...
//  Структура - см. ФорматыЭДО.НовыйРезультатФормированияДокумента
...
// 
// Возвращаемое значение:
//  Структура - см. НовыйРезультатПроверкиЗаполненияДанных
Функция ПроверитьЗаполнениеДанных(Знач Формат, Знач Данные) Экспорт
...
Процедура ПрочитатьДанныеПоРасчетнымСчетамКонтрагентаCML(
	...
	ДеревоРазбора = ДанныеРазбора.ДеревоРазбора;
	НаборДанных = РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(РасчетныеСчетаXDTO, "РасчетныйСчет",,, Истина);
	...
	Для Каждого РасчетныйСчетXDTO Из НаборДанных Цикл
		...
		РеквизитыБанка = Новый Структура;
		РеквизитыБанка.Вставить("Код",          РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(БанкXDTO, "БИК", "", "Строка"));
		РеквизитыБанка.Вставить("Наименование", РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(БанкXDTO, "Наименование", "", "Строка"));
		РеквизитыБанка.Вставить("КоррСчет",		РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(БанкXDTO, "СчетКорреспондентский", "", "Строка"));
		РеквизитыБанка.Вставить("SWIFT",		РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(БанкXDTO, "SWIFT", "", "Строка"));
		
		СписокТЧ.Добавить(РеквизитыБанка.Код,			"БанкБИК");
		СписокТЧ.Добавить(РеквизитыБанка.Наименование,	"БанкНаименование");
		СписокТЧ.Добавить(РеквизитыБанка.КоррСчет,		"БанкСчетКорр");
		СписокТЧ.Добавить(РеквизитыБанка.SWIFT, 		"БанкSWIFT");
		...
		СтрокаБанка = ДеревоЭлектронногоДокументаБЭД.НайтиСоздатьСтрокуВДеревеРазбора(ТипБанкиВДереве, РеквизитыБанка.Код, 
			"БИК: " + РеквизитыБанка.Код, БанкСсылка, РеквизитыБанка, ДанныеРазбора, Ошибка);
		
		// Обработка банка корреспондента
		БанкКорреспондентXDTO = ?(РасчетныйСчетXDTO.Свойства().Получить("БанкКорреспондент") = Неопределено, 
			Неопределено, РасчетныйСчетXDTO.БанкКорреспондент);
		Если БанкКорреспондентXDTO <> Неопределено Тогда
			
			РеквизитыБанкаКорреспондента = Новый Структура;
			РеквизитыБанкаКорреспондента.Вставить("Код",			
				РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(БанкКорреспондентXDTO, "БИК", "", "Строка"));
			РеквизитыБанкаКорреспондента.Вставить("Наименование",	
				РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(БанкКорреспондентXDTO, "Наименование", "", "Строка"));
			РеквизитыБанкаКорреспондента.Вставить("КоррСчет",		
				РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(БанкКорреспондентXDTO, "СчетКорреспондентский", "", "Строка"));
			РеквизитыБанкаКорреспондента.Вставить("SWIFT",			
				РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(БанкКорреспондентXDTO, "SWIFT", "", "Строка"));
			
			СписокТЧ.Добавить(РеквизитыБанкаКорреспондента.Код,				"БанкКоррБИК");
			СписокТЧ.Добавить(РеквизитыБанкаКорреспондента.Наименование,	"БанкКоррНаименование");
			СписокТЧ.Добавить(РеквизитыБанкаКорреспондента.КоррСчет, 		"БанкКоррСчетКорр");
			СписокТЧ.Добавить(РеквизитыБанкаКорреспондента.SWIFT, 			"БанкКоррSWIFT");
		...
		СписокТЧ.Добавить(РеквизитыБанковскогоСчета.НомерСчета,		"НомерСчета");
		СписокТЧ.Добавить(РеквизитыБанковскогоСчета.Комментарий,	"Комментарий");
		...
		// Заполняем реквизиты банковского счета
		ДеревоЭлектронногоДокументаБЭД.ДобавитьРеквизитШапкиОбъекта(СтрокаСчета, "Банк", СтрокаБанка.ИндексСтроки);
		Если Не БанкКорреспондентXDTO = Неопределено Тогда
			ДеревоЭлектронногоДокументаБЭД.ДобавитьРеквизитШапкиОбъекта(СтрокаСчета, "БанкКорреспондент", СтрокаБанкаКорреспондента.ИндексСтроки);
		КонецЕсли;	
