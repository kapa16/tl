...
// Настройки регулирующие поведение на этапе подготовки объектов учета к документообороту.
// 
// Параметры:
//  ТекущиеПараметры - См. ИнтеграцияЭДОКлиент.ПереопределяемыеНастройкиПодготовкиКДокументообороту
Процедура ПараметрыЭтапаПодготовкиКДокументообороту(ТекущиеПараметры) Экспорт
КонецПроцедуры

// Событие возникает при проверке готовности объектов учета к формированию электронных документов.
// 
// Параметры:
//  ОбъектыУчета - Массив Из ОпределяемыйТип.ОснованияЭлектронныхДокументовЭДО
//  ОбработчикПродолжения - ОписаниеОповещения - если СтандартнаяОбработка = Ложь, необходимо вызывать этот обработчик,
//                                               передав в качестве результата массив объектов учета, по которым
//                                               будет продолжено формирование электронных документов.
//  СтандартнаяОбработка - Булево - если требуется дополнительные интерактивные действия от пользователя, нужно установить
//                                  параметр в Ложь и по завершению вызывать ОбработчикПродолжения.
...
Процедура ПриЗаполненииНалоговогоОргана(ОповещениеОЗавершении, Организация, СтандартнаяОбработка) Экспорт
	...
	ДополнительныеПараметры.Вставить("ОповещениеОЗаполненииНалоговогоОргана", ОповещениеОЗавершении);
	
	ОписаниеОповещенияОЗакрытии = Новый ОписаниеОповещения(Неопределено,, ДополнительныеПараметры);
	ОткрытьФорму("Справочник.Организации.Форма.ФормаОрганизации", ПараметрыФормы,,,,, ОписаниеОповещенияОЗакрытии);
	// {/УАТ}
КонецПроцедуры
...
// 
// Параметры:
//  ВариантыВыбораФайла - см. Обработка.ФорматДоговорныйДокумент101.Форма.ВыполнениеКлиентскихМетодов.НовыеВариантыВыбораФайла //АПК:404 не проверять наличие метода 
...
// Определяет использовать ли новую форму подключения учетной записи
// Форма не обладает всеми возможностями помощника расширенного интерфейса.
//
// Параметры:
//  ИспользоватьПомощникЛегкогоИнтерфейса - Булево
Процедура ПриОпределенииИнтерфейсаПомощникаПодключения(ИспользоватьПомощникЛегкогоИнтерфейса) Экспорт
...
//
// Параметры:
//  ПараметрыФормы - см. ОтражениеВУчетеЭДОКлиент.НовыеПараметрыФормыНастройкиОтраженияВУчете
//  ПараметрыОткрытияФормы - см. ОбщегоНазначенияБЭДКлиент.ОткрытьФормуБЭД.ПараметрыОткрытияФормы
//  СтандартнаяОбработка - Булево
//
Процедура ОткрытьНастройкуОтраженияВУчете(ПараметрыФормы, ПараметрыОткрытияФормы, СтандартнаяОбработка) Экспорт

КонецПроцедуры

// Выполняется при нажатии на кнопку "Создать" для отражения учетного документа
// 
// Параметры:
...
// Перехват обработчиков событий, возникающих в формах электронных документов.
// Только для вызовов из КлиентЭДО.

// Обработчик события ОбработкаНавигационнойСсылки формы просмотра электронного документа (легкий КлиентЭДО).
// 
// Параметры:
//  Форма - ФормаКлиентскогоПриложения
//  НавигационнаяСсылкаФорматированнойСтроки - Строка
//  СтандартнаяОбработка - Булево
Процедура ОбработкаНавигационнойСсылкиФормыПросмотраЭлектронногоДокумента(Форма, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка) Экспорт
	
КонецПроцедуры

// Выполнить переопределяемую команду (легкий КлиентЭДО).
// 
// Параметры:
//  Форма - ФормаКлиентскогоПриложения
...
// Обработчик события ОбработкаОповещения форм просмотра электронных документов и текущих дел (легкий КлиентЭДО).
// 
// Параметры:
//  Форма - ФормаКлиентскогоПриложения - 
//  ИмяСобытия - Строка -
...
// Устарела. Событие возникает непосредственно перед запуском формирования электронных документов, до запуска внутренних проверок.
...
// Устарела. Событие возникает непосредственно перед утверждением входящих электронных документов. Позволяет выполнить дополнительные
