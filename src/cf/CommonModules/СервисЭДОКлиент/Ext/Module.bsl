...
Функция ПодготовитьДанныеНаПодпись(ДанныеПакета, ПараметрыРегистрации, СертификатыПодписейОрганизации) Экспорт
	...
	Операция = ОперацияПодписаниеРегистрационныхДанных();
...
// Возвращает представление операции подписания рег. данных на подключение к сервису 1С-ЭДО
// Возвращаемое значение:
//  Строка - Представление операции
//
Функция ОперацияПодписаниеРегистрационныхДанных() Экспорт

	Возврат НСтр("ru = 'Подписание регистрационных данных на подключение к сервису 1С-ЭДО'");
...
Процедура ЗаполнитьПодписантаДанныхДляОператораЭДО(РезультатВыбораСертификата, ПараметрыРегистрации) Экспорт
	...
	Если ДанныеДляРегистрационногоПакета.Свойство("ТекстОшибки") И ЗначениеЗаполнено(ДанныеДляРегистрационногоПакета.ТекстОшибки) Тогда
		ТекстОшибки = ДанныеДляРегистрационногоПакета.ТекстОшибки;
