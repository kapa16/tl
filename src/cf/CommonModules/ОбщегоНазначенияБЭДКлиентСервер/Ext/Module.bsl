...
// * АвтоматическоеПолучениеЭДО - Строка
// * РаботаСНоменклатурой - Строка
// * ТЭДО - Строка
Функция ПодсистемыБЭД() Экспорт
	...
	Подсистемы.Вставить("АвтоматическоеПолучениеЭДО", "ЭлектронноеВзаимодействие.ОбменСКонтрагентами.АвтоматическоеПолучениеЭДО");
	Подсистемы.Вставить("РаботаСНоменклатурой", "ЭлектронноеВзаимодействие.РаботаСНоменклатурой");
	Подсистемы.Вставить("ТЭДО", "ЭлектронноеВзаимодействие.ОбменСКонтрагентами.ТрансграничныйЭДО");
...
Функция ДекодированныеДвоичныеДанные(ДвоичныеДанные) Экспорт
	...
	Если ТипЗнч(ДекодированныеДанные) = Тип("ДвоичныеДанные")
			И ДекодированныеДанные.Размер() > 0 Тогда
...
//  НачалоСтроки - Строка
// 
Процедура УдалитьЗначенияПоНачалуСтроки(Список, НачалоСтроки) Экспорт
	Если Не ТипЗнч(Список) = Тип("СписокЗначений") Тогда
		Возврат;
	КонецЕсли;
	
	КоличествоЭлементовКоллекции = Список.Количество();
	
	Для ОбратныйИндекс = 1 По КоличествоЭлементовКоллекции Цикл
		
		Индекс = КоличествоЭлементовКоллекции - ОбратныйИндекс;
		
		ЗначениеИзСписка = Список[Индекс].Значение;
		Если ТипЗнч(ЗначениеИзСписка) = Тип("Строка") И СтрНачинаетсяС(ЗначениеИзСписка, НачалоСтроки) Тогда
...
//  Булево 
//
Функция ЭтоСтруктураСПустымиЗначениями(Структура) Экспорт
	Результат = Истина;
...
Функция ЭтоПодчеркивание(Знач Символ)
	КодСимвола = КодСимвола(Символ);
