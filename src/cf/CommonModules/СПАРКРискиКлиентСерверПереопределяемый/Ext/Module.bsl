...
Процедура ПриОпределенииСвойствКонтрагентаВОбъекте(КонтрагентОбъект, Форма, СвойстваКонтрагента) Экспорт
	...
	Если КонтрагентОбъект.СтранаРегистрации = ПредопределенноеЗначение("Справочник.СтраныМира.Россия")
		Или КонтрагентОбъект.СтранаРегистрации = ПредопределенноеЗначение("Справочник.СтраныМира.ПустаяСсылка") Тогда
		СвойстваКонтрагента.ПодлежитПроверке = Истина;
	КонецЕсли;
	СвойстваКонтрагента.СвояОрганизация = Ложь;
	
	ВидКонтрагента = КонтрагентОбъект.ЮридическоеФизическоеЛицо;
	...
	Иначе
		СвойстваКонтрагента.ВидКонтрагента = ПредопределенноеЗначение("Перечисление.ВидыКонтрагентовСПАРКРиски.ПустаяСсылка");
	КонецЕсли;
	// {/УАТ}
