...
// 
// Возвращаемое значение:
// см. Перечисления.ТипыДокументовЭДО.СтандартныеТипыДокументов
// см. ТрансграничныйЭДО.СтандартныеТипыДокументов
//
Функция СтандартныеТипыДокументов() Экспорт
	
	Результат = Перечисления.ТипыДокументовЭДО.СтандартныеТипыДокументов();
	Если ТрансграничныйЭДО.ТипыДокументовИспользуются() Тогда
		ОбщегоНазначенияКлиентСервер.ДополнитьСтруктуру(Результат, ТрансграничныйЭДО.СтандартныеТипыДокументов());
	КонецЕсли;
	Возврат Результат;
...
// * ОшибкиСозданияПоФайлу - Массив Из см. ЭлектронныеДокументыЭДОСлужебный.НовыеДанныеОшибкиСозданияПоФайлу
...
Функция СвойстваСообщенийПросмотраКарточкиДокумента(ЭлектронныйДокумент) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЭлектронноеВзаимодействие.ОбменСГИСЭПД") Тогда
		МодульОбменСГИСЭПД = ОбщегоНазначения.ОбщийМодуль("ОбменСГИСЭПД");
	    МодульОбменСГИСЭПД.ПриПолученииСвойствСообщенийПросмотраКарточкиДокумента(Запрос);
	КонецЕсли;
