...
Процедура сфпВыполнитьЗвонокПоНомеру(ВыбранныйНомер, ДополнительныеПараметры) Экспорт
	...
	сфпПозвонить(ПараметрыТелефона.Телефон, ПараметрыТелефона.Контакт, ДополнительныеПараметры.ДанныеЗаполнения, ПараметрыТелефона.ЗадержкаДобавочногоНомера, ПараметрыТелефона.ПрефиксНабора);
