...
Процедура ПриОпределенииОбъектовСКомандамиСозданияНаОсновании(Объекты) Экспорт
	...
	// {УАТ}
	Объекты.Добавить(Метаданные.Документы.уатЗаказГрузоотправителя);
	Объекты.Добавить(Метаданные.Документы.уатПутевойЛист);
	Объекты.Добавить(Метаданные.Документы.уатМаршрутныйЛист);
	
	Если НЕ уатОбщегоНазначенияПовтИсп.ВариантПоставкиСТД() Тогда
		Объекты.Добавить(Метаданные.Документы.уатЗаказПеревозчику_уэ);
		Объекты.Добавить(Метаданные.Документы.уатПотребностьВПеревозке_уэ);
	КонецЕсли;
	// {/УАТ}
