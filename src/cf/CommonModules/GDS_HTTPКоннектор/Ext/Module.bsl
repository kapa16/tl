...
Функция ПодготовитьЗапрос(Сессия, Метод, URL, ДополнительныеПараметры) Экспорт
	...
	//СУ+++Доработки_МеКаМи
	// Иначе формирует некорректные заголовки и некорректно работает с Кафка
...
Процедура ПодготовитьТелоЗапроса(ПодготовленныйЗапрос, Данные, Файлы, Json, ПараметрыЗаписиJSON)
	...
	Если ЗначениеЗаполнено(ContentType) Тогда//Если ЗначениеЗаголовка = Ложь И ЗначениеЗаполнено(ContentType) Тогда
