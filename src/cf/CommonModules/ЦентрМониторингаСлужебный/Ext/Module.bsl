...
#КонецОбласти
	...
	Возврат пр_ПоддержкаОтраслевыхРешенийСлужебный.ПриФормированииПакетаДляОтправки(JSONСтруктура, Параметры);
...
Функция ОтправитьДанныеМониторинга(ТестовыйПакет = Ложь)
	...
	// {УАТ}
	Расширения = РасширенияКонфигурации.Получить(Новый Структура("Имя", "ОтключениеОтправкиСтатистики"));
...
Функция ПолучитьПараметрыПоУмолчанию()
	...
	// {УАТ}
	// ПоддержкаОтраслевыхРешений
	Возврат пр_ПоддержкаОтраслевыхРешенийСлужебный.ПриПолученииПараметровЦентраМониторинга(ПараметрыКонстанты);
	// Конец ПоддержкаОтраслевыхРешений
	// {УАТ}
...
Функция УстановитьПараметрыОтправки(Параметры)
	...
	// {УАТ}
	// ПоддержкаОтраслевыхРешений
	Возврат пр_ПоддержкаОтраслевыхРешенийСлужебный.ПриПолученииОтветаОтСервера(Параметры, ПараметрыОтправки);
	// Конец ПоддержкаОтраслевыхРешений
	// {/УАТ}
...
Процедура ОтправитьТестовыйПакет(ПараметрыВыполнения, АдресРезультата) Экспорт
	...
	// {УАТ}
	// ПоддержкаОтраслевыхРешений
	пр_ПоддержкаОтраслевыхРешенийСлужебный.ПриОтправкеТестовогоПакета(ПараметрыВыполнения);
	// Конец ПоддержкаОтраслевыхРешений
	// {/УАТ}
