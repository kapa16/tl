...
//  * ПараметрыОбмена - см. ПараметрыОбменаЭДОДляСозданияДокументаПоФайлу - Параметры обмена ЭДО
//                    - Неопределено - Если не указаны, то берутся из настроек
//
...
// Возвращает новые параметры обмена ЭДО для создания документа по файлу
// 
// Возвращаемое значение:
//  Структура:
//    * ИдентификаторОтправителя - Строка - ИД ЭДО отправителя документа
//    * ИдентификаторПолучателя - Строка - ИД ЭДО получателя документа
//    * ТребуетсяИзвещениеОПолучении - Булево - Настройка требования извещения о получении
//    * ТребуетсяОтветнаяПодпись - Булево - Настройка ожидания ответной подписи
Функция ПараметрыОбменаЭДОДляСозданияДокументаПоФайлу() Экспорт
	
	Возврат ЭлектронныеДокументыЭДОКлиентСервер.НовыеПараметрыОбменаЭДОДляСозданияДокументаПоФайлу();
...
// Начать процесс приглашения контрагента к обмену ЭДО.
// 
// Параметры:
//  ПараметрКоманды - см. ОбменСКонтрагентамиПереопределяемый.СвязанныеКонтрагенты.СсылкиНаОбъекты
Процедура ПригласитьКОбменуЭДО(ПараметрКоманды) Экспорт
	
	ИнтерфейсДокументовЭДОКлиент.ПригласитьКОбменуЭДО(ПараметрКоманды, Неопределено);
	
КонецПроцедуры

// Конец КлиентЭДО

// Открыть форму выбора перечня специальных обстоятельств ФНС.
// 
// Параметры:
...
Процедура ОткрытьФормуПросмотраСпециальногоОбстоятельстваФНС(КодСпециальногоОбстоятельства, Владелец) Экспорт
	...
	ТипЗначения = Тип("РегистрСведенийКлючЗаписи.ПереченьСпециальныхОбстоятельствДокументаЭДО");
	ЗначенияКлюча = Новый Структура("Код", КодСпециальногоОбстоятельства);
	
	КлючЗаписи = ОбщегоНазначенияБЭДКлиент.КлючЗаписиРегистраСведений(ТипЗначения, ЗначенияКлюча);
...
// Возвращает путь к форме текущих дел ЭДО в зависимости от пользовательских настроек и переопределения
// учетной системой.
// 
// Возвращаемое значение:
//  Строка
Функция ПутьКФормеТекущихДелЭДО() Экспорт
	Возврат ИнтерфейсДокументовЭДОКлиент.ФормаТекущиеДелаПоЭДО();
КонецФункции

// Конструктор параметров оповещения для формы документа.
//
// Возвращаемое значение:
//  См. ЛегкийИнтерфейсДокументовЭДОКлиент.ПараметрыОповещенияЭДО_ФормаДокумента
//
Функция ПараметрыОповещенияЭДО_ФормаДокумента_ЛегкийКлиентЭДО() Экспорт
	Возврат ЛегкийИнтерфейсДокументовЭДОКлиент.ПараметрыОповещенияЭДО_ФормаДокумента();
КонецФункции
...
//  Параметр - Произвольный - Параметр сообщения. Могут быть переданы любые необходимые данные.
//  Источник - Произвольный - Источник события. Например, в качестве источника может быть указана другая форма.
//  ПараметрыОповещения - См. ПараметрыОповещенияЭДО_ФормаДокумента_ЛегкийКлиентЭДО
//
Процедура ОбработкаОповещения_ФормаДокумента_ЛегкийКлиентЭДО(ИмяСобытия, Параметр, Источник,
	ПараметрыОповещения) Экспорт
	
	ЛегкийИнтерфейсДокументовЭДОКлиент.ОбработкаОповещения_ФормаДокумента(ИмяСобытия, Параметр, Источник,
		ПараметрыОповещения);
	
КонецПроцедуры

// Вызывает оповещение форм электронных документов о событии изменения связанных документов. 
// 
// Параметры:
//  СвязанныеДокументы - Массив Из ОпределяемыйТип.ОснованияЭлектронныхДокументовЭДО
Процедура ОповеститьОбИзмененииСвязанныхДокументовОснованийЭлектронныхДокументов(СвязанныеДокументы) Экспорт
	
	ЛегкийИнтерфейсДокументовЭДОКлиент.ОповеститьОбИзмененииСвязанныхДокументовОснованийЭлектронныхДокументов(СвязанныеДокументы);

КонецПроцедуры

// Полные имена форм, используемые для ручного формирования ответных титулов.
// 
// Возвращаемое значение:
//  Структура:
//  * ОбщаяФорма - Строка
...
Функция ФормыРучногоФормированияТитула() Экспорт
	...
	Возврат ИнтерфейсДокументовЭДОКлиентСервер.ФормыРучногоФормированияТитула();
