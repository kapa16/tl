...
// Событие после успешной фискализации чека на ККТ с маркированными товарами 
// Параметры:
//  ИдентификаторУстройстваККТ - СправочникСсылка.ПодключаемоеОборудование - выбранное ККТ
//  ОтчетВыбытииМТ - Структура - Отчет о выбытии МТ
//
Процедура ПриФискализацииЧекаСМаркированнымиТоварами(ИдентификаторУстройстваККТ, ОтчетВыбытииМТ) Экспорт
...
// Вызывается из процедуры ВыполнитьКоманду_Подключаемый из формы проверки возраста в Макс
// Параметры:
//  Форма - ФормаКлиентскогоПриложения
//  Команда - Команда
//
Процедура ПриВыполненииКомандыНаФормеПроверкиВозрастаВМакс(Форма, Команда) Экспорт
