...
Функция ПолучитьHTMLПредпросмотрОбъектаАсинхронно(УникальныйИдентификаторФормы, ID, Тип, ИгнорироватьМаксРазмер = Ложь,
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания =
		НСтр("ru = 'Получение HTML предпросмотра объекта из 1С:Документооборот'; en = 'Get object preview HTML from 1C:Document Management'");
...
Функция ПеренестиФайлыИСвДО(ПрисоединенныеФайлыВИС, ВладелецID, ВладелецТип, ВладелецИС,
	...
	Иначе
		ВызватьИсключение НСтр("ru = 'Отсутствует стандартная подсистема ""Работа с файлами""'; en = 'The standard ""File management"" subsystem is missing'");
	КонецЕсли;
