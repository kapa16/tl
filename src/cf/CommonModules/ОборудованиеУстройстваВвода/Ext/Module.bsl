...
Процедура ОбновитьПоставляемыеДрайвера(ДрайвераОборудования) Экспорт
	...
	Драйвер.Наименование = НСтр("ru = '1С:Сканеры штрихкода (COM)'; en = '1C:Barcode scanners (COM)'");
	...
	Драйвер.Наименование = НСтр("ru = '1С:Считыватели магнитных карт'; en = '1С:Считыватели магнитных карт'");
	Драйвер.ИдентификаторОбъекта = "AddIn.Scanner"; 
	Драйвер.СнятСПоддержки = Истина;
	...
	Драйвер.Наименование = НСтр("ru = 'АТОЛ:Сканеры штрихкода'; en = 'ATOL:Barcode scanners'");
	...
	Драйвер.Наименование = НСтр("ru = 'АТОЛ:Считыватели магнитных карт'; en = 'ATOL: Magnetic stripe card readers'");
	Драйвер.ИдентификаторОбъекта = "AddIn.Scaner45"; 
	Драйвер.СнятСПоддержки = Истина;
	...
	Драйвер.Наименование = НСтр("ru = 'Сканкод:Сканеры штрихкода'; en = 'Scancode:Barcode scanners'");
