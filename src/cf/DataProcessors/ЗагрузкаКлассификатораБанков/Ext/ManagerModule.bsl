...
Функция ИмяСобытияВЖурналеРегистрации()
	...
	Возврат НСтр("ru = 'Загрузка классификатора банков.ИПП';
				|en = 'Import bank classifier.Online support'", ОбщегоНазначения.КодОсновногоЯзыка());
		...
		Исключение
			...
			ЗаписатьОшибкуВЖурналРегистрации(
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр(
					...
					|%3';
					|en = 'Cannot update information about the ""%1"" settlement party (bank code %2):
					|%3'"),
					Выборка.Ссылка,
					Выборка.Код,
