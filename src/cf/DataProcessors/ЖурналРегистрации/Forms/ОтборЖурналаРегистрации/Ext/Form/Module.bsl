...
Процедура СохранитьНастройкиВФайл(Команда)
	...
	ПараметрыСохраненияФайла.Диалог.Фильтр = НСтр("ru = 'Настройки журнала регистрации';
													|en = 'Event log settings'") + "(*.xml)|*.xml";
...
Процедура ЗагрузитьНастройкиИзФайла(Команда)
	...
	ПараметрыЗагрузкиФайла.Диалог.Заголовок = НСтр("ru = 'Выберите файл с настройками отбора журнала регистрации';
													|en = 'Choose a file with event log filter settings'");
	ПараметрыЗагрузкиФайла.Диалог.Фильтр = НСтр("ru = 'Файл xml';
												|en = 'XML file'") + "(*.xml)|*.xml";
...
Процедура ЗагрузитьНастройкиИзФайлаЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ПоказатьОповещениеПользователя(НСтр("ru = 'Настройки отбора';
										|en = 'Filter settings'"),, НСтр("ru = 'Настройки отбора загружены';
																			|en = 'Filter settings are imported'"));
