...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЕстьАдресаты И ЕстьФактИсполнители Тогда
		Заголовок = НСтр("ru = 'Выбор фактического исполнителя и сотрудника, за которого выполняется задача'; en = 'Select an actual assignee and an employee whose task is to be performed'");
		УстановитьКлючНазначенияФормы("ПланФакт");
	ИначеЕсли ЕстьАдресаты Тогда
		Заголовок = НСтр("ru = 'Выбор сотрудника, за которого выполняется задача'; en = 'Select an employee whose task is to be performed'");
		УстановитьКлючНазначенияФормы("План");
		Элементы.ПояснениеАдресаты.Заголовок = НСтр("ru = 'Укажите сотрудника:'; en = 'Select an employee:'");
	Иначе
		Заголовок = НСтр("ru = 'Выбор фактического исполнителя задачи'; en = 'Selecting the actual performer of the task'");
