...
Процедура ОбновитьДеревоУчастниковПоОбъекту(ДействиеXDTO)
	...
	ЭтапЗарегистрировать.НаименованиеЭтапа = НСтр("ru = 'Зарегистрировать'; en = 'Register'");
	...
	ЭтапОзнакомление.НаименованиеЭтапа = НСтр("ru = 'Ознакомиться с результатом регистрации'; en = 'Review the registration result'");
...
Процедура ОбновитьОбъектПоДеревуУчастников(Прокси, ДействиеXDTO)
	...
	ИначеЕсли Не ЕстьОбрабатывающийРезультат Тогда
		ВызватьИсключение НСтр("ru = 'Отсутствует участник ""ознакомления с результатом регистрации""'; en = 'The ""Registration result review"" participant is missing'");
	КонецЕсли;
