...
Процедура СобратьПредставлениеУсловия(ТекущиеДанные)
	...
	Если ЗначениеЗаполнено(Оператор) Тогда
		Если Тип = "Строка" Тогда
			Если Оператор = "=" Тогда
				Представление = СтрШаблон(НСтр("ru = 'равно ""%1""'; en = 'is ""%1""'"), Значение);
				
			ИначеЕсли Оператор = "LIKE" Тогда
				Если Лев(Значение, 1) = "%" И Прав(Значение, 1) = "%" Тогда
					Представление = СтрШаблон(
						НСтр("ru = 'содержит ""%1""'; en = 'contains ""%1""'"), Сред(Значение, 2, СтрДлина(Значение) - 2));
					
				ИначеЕсли Лев(Значение, 1) = "%" Тогда
					Представление = СтрШаблон(НСтр("ru = 'заканчивается на ""%1""'; en = 'ends with ""%1""'"), Сред(Значение,2));
					
				ИначеЕсли Прав(Значение, 1) = "%" Тогда
					Представление = СтрШаблон(
						НСтр("ru = 'начинается с ""%1""'; en = 'starts with ""%1""'"), Лев(Значение, СтрДлина(Значение) - 1));
		...
		ИначеЕсли Тип = "Число" Тогда
			...
			ИначеЕсли ЗначениеЗаполнено(Оператор2) Тогда
				Представление = СтрШаблон(НСтр("ru = 'между %1 и %2'; en = 'between %1 and %2'"), Значение, Значение2);
				
			ИначеЕсли Оператор = "<=" Тогда
				Представление = СтрШаблон(НСтр("ru = 'по %1'; en = 'to %1'"), Значение);
				
			ИначеЕсли Оператор = ">=" Тогда
				Представление = СтрШаблон(НСтр("ru = 'от %1'; en = ', %1'"), Значение);
		...
		ИначеЕсли Тип = "Дата" Тогда
			Если Оператор = "=" Тогда
				...
				Иначе
					Представление = "(" + НСтр("ru = 'пустая'; en = 'empty'") + ")";
				КонецЕсли;
				
			ИначеЕсли ЗначениеЗаполнено(Оператор2) Тогда
				Представление = СтрШаблон(
					НСтр("ru = 'между %1 и %2'; en = 'between %1 and %2'"), Формат(Значение, "ДЛФ=D"), Формат(Значение2, "ДЛФ=D"));
				
			ИначеЕсли Оператор = "<=" Тогда
				Представление = СтрШаблон(НСтр("ru = 'по %1'; en = 'to %1'"), Формат(Значение, "ДЛФ=D"));
				
			ИначеЕсли Оператор = ">=" Тогда
				Представление = СтрШаблон(НСтр("ru = 'с %1'; en = 'from %1'"), Формат(Значение, "ДЛФ=D"));
