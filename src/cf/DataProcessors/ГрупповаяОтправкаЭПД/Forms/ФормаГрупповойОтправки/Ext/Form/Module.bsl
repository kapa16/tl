...
Процедура ЗаписатьНаСервере(Отказ, ПараметрыЗаписи, СсылкаДляЗаписи)
	...
	Если ТекущийОбъектСтруктура <> Неопределено И Не ЗначениеЗаполнено(ТекущийОбъект.УИДМинтранс) Тогда
		ТекущийОбъект.УИДМинтранс = ТекущийОбъектСтруктура.УИДМинтранс;
	КонецЕсли;
