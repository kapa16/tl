...
Функция ВыполнениеОбработкиНаСервере()
	...
	ЗагружатьДанныеПоВремениРаботыДвигателя = СтруктураПараметров.ЗагружатьДанныеПоВремениРаботыДвигателя;
	ИнтервалЗагрузкиПробега = СтруктураПараметров.ИнтервалЗагрузкиПробега;
	
	ПараметрыПроцедуры = Новый Структура("ВнешняяСистема,ДатаНачала,ДатаОкончания,МассивТС,
	|ЗагрузитьПробегРасход,ЗагрузитьДопСведения,ЗагрузитьКоординаты,ЗагружатьДанныеПоВремениРаботыДвигателя,
	|ИнтервалЗагрузкиПробега");
	...
	ПараметрыПроцедуры.ЗагружатьДанныеПоВремениРаботыДвигателя = ЗагружатьДанныеПоВремениРаботыДвигателя;
	ПараметрыПроцедуры.ИнтервалЗагрузкиПробега = ИнтервалЗагрузкиПробега;
