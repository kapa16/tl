...
// {УАТ}
&НаКлиенте
Процедура ВыборОператораЭДО(Команда)
	ОткрытьФорму("ОбщаяФорма.уатВыборОператораЭДО", , ЭтотОбъект);
КонецПроцедуры
// {/УАТ}
...
Процедура ПрочитатьУстановитьДоступность(РеквизитПутьКДанным = "")
	...
	// {УАТ}
	Элементы.ГруппаВыборОператораЭДО.Доступность = ПолучитьФункциональнуюОпцию("ИспользоватьОбменЭД");
	// {/УАТ}
