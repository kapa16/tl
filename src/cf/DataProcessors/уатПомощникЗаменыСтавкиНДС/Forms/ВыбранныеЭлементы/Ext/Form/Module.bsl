...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Объект.СтараяСтавкаНДС = Параметры.СтараяСтавкаНДС;
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Список, "СтараяСтавкаНДС", Объект.СтараяСтавкаНДС);
