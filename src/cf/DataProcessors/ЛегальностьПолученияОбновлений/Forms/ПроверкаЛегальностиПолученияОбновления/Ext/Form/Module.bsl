...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	пр_ПоддержкаОтраслевыхРешенийСлужебный.ПриСозданииНаСервере(ЭтотОбъект, Отказ, СтандартнаяОбработка);
	...
	Если ИнформационныйМакет = Неопределено Тогда
			ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'В обработке %1 отсутствует макет %2. Требуется добавить его в конфигурацию.';
					|en = 'The required template %2 is missing from the data processor %1.'"),
