...
&НаКлиенте
Процедура ВыполнитьРегламентноеЗаданиеЗагрузкаДанныхИзПаркоматика(Команда)
	ВыполнитьРегламентноеЗаданиеВручную(ЗагрузкаДанныхИзПаркоматика, "Загрузка данных из Паркоматика");
КонецПроцедуры
...
&НаКлиенте
Процедура НастроитьРеглЗаданиеЗагрузкаДанных(Команда)
	ПараметрыФормы = Новый Структура;
	ПараметрыФормы.Вставить("Идентификатор", ЗагрузкаДанныхИзПаркоматика);
...
Процедура ОбновитьДанныеРеглЗаданийСервер()
	...
	РеглЗаданиеЗагрузкаДанныхИзПаркоматика = РегламентныеЗаданияСервер.Задание(Метаданные.РегламентныеЗадания.уатЗагрузкаДанныхИзПаркоматика);
	ЗагрузкаДанныхИзПаркоматика = РеглЗаданиеЗагрузкаДанныхИзПаркоматика.УникальныйИдентификатор;

	Подсказка =  НСтр("ru='Никогда не выполнялось';en='Never execute'");
	Если РеглЗаданиеЗагрузкаДанныхИзПаркоматика = Неопределено Тогда
	...
	Иначе
		...
		|ИдентификаторРегламентногоЗадания", Истина, ЗагрузкаДанныхИзПаркоматика));
		Подсказка = ?(РеглЗаданиеЗагрузкаДанныхИзПаркоматика.Использование, 
