...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ЭтоТаблица Тогда
		Заголовок = НСтр("ru = 'Выбор таблицы 1С:Документооборота'; en = 'Select 1C:Document Management table'");
	Иначе
		Заголовок = НСтр("ru = 'Выбор реквизита 1С:Документооборота'; en = 'Select 1C:Document Management attribute'");
	КонецЕсли;
...
Процедура ЗаполнитьДеревоРеквизитов(РеквизитыОбъектаДО, ИмяРеквизитаОбъектаДО, ПредставлениеРеквизитаОбъектаИС,
	...
	Для Каждого Реквизит Из РеквизитыОбъектаДО Цикл // см. ИнтеграцияС1СДокументооборотБазоваяФункциональностьКлиентСервер.ДанныеРеквизита
		...
		Если Реквизит.ЭтоТаблица Тогда
			...
			НоваяСтрока.Тип = НСтр("ru = 'Таблица'; en = 'Table'");
		Иначе
	...
	Дерево.Строки.Сортировать("ЭтоТаблица, ЭтоДополнительныйРеквизитДО, Представление");
