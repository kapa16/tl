...
Процедура КомандаОтмена(Команда)
	...
	ТекстВопроса = НСтр("ru = 'Все изменения будут потеряны. Закрыть эту форму?'; en = 'All changes will be lost. Close the form?'");
...
Процедура НастроитьПанельИОшибкиКомплекта(НастраиваемыйКомплект = Неопределено)
	...
	Для Каждого СтрокаДанных Из СтрокиДляОбхода Цикл
		...
		Иначе
			ДатаВДекорации = "";
		КонецЕсли;
		Элементы["ДекорацияТекст" + ИмяТаблицы].Заголовок = СтрШаблон(НСтр("ru = '%1%2%3'; en = '%1%2%3'"),
...
" - документы должны принадлежать одному комплекту.'; en = 'Some kits contain errors and cannot be processed."
