...
Процедура Применить(Команда)
	...
	Результат = НСтр("ru = 'Проверка промокода, секундочку...'; en = 'Checking the promo code. Please wait…'");
...
Функция НачатьПроверкуПромокода()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru = 'Активация промокода в фоне'; en = 'Activate a promo code in the background'");
