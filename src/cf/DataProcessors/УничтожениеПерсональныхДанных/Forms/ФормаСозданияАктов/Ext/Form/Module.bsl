...
Процедура СоздатьАкты(Команда)
	...
	// {УАТ}
	Результат.Вставить("ФИООтветственногоЗаОбработкуПДн", ПолучитьФИООтветственногоЗаОбработкуПДн());
	// {/УАТ}
...
// {УАТ}
&НаСервере
Функция ПолучитьФИООтветственногоЗаОбработкуПДн()
	...
	ЗащитаПерсональныхДанныхПереопределяемый.ЗаполнитьФИОФизическогоЛица(ОтветственныйФизическоеЛицо,
		ФИООтветственногоЗаОбработкуПДн);
	Возврат ФИООтветственногоЗаОбработкуПДн;
КонецФункции
