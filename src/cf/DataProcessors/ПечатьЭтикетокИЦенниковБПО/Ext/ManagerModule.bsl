	...
	Если ДанныеЭтикетки.Количество()>0 Тогда
		...
		Для Каждого Поле Из ДанныеЭтикетки.Поля Цикл
			...
			ИначеЕсли ОписаниеПоля.Тип = "Image" Тогда 
				...
				Если ОписаниеПоля.РазмерКартинки = "Stretch" Тогда
					РазмерКартинкиОбласти = РазмерКартинки.Растянуть;
				ИначеЕсли ОписаниеПоля.РазмерКартинки = "AutoSize" Тогда
					РазмерКартинкиОбласти = РазмерКартинки.АвтоРазмер;
				ИначеЕсли ОписаниеПоля.РазмерКартинки = "ByFontSize" Тогда
					РазмерКартинкиОбласти = РазмерКартинки.ПоРазмеруШрифта;
				ИначеЕсли ОписаниеПоля.РазмерКартинки = "Proportionally" Тогда
					РазмерКартинкиОбласти = РазмерКартинки.Пропорционально;
				ИначеЕсли ОписаниеПоля.РазмерКартинки = "RealSize" Тогда
					РазмерКартинкиОбласти = РазмерКартинки.РеальныйРазмер;
				ИначеЕсли ОписаниеПоля.РазмерКартинки = "Tile" Тогда
					РазмерКартинкиОбласти = РазмерКартинки.Черепица;
				КонецЕсли;
				ОбластьТабличногоДокумента.РазмерКартинки = РазмерКартинкиОбласти;
...
Функция НовыйОписаниеПоля()
	...
	Результат.Вставить("РазмерКартинки",         "Stretch");
