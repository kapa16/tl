		...
		Если КоличествоСсылок = 1 Тогда
			ТекстСообщения =
				НСтр("ru = 'Объект уже используется в других местах в приложении.
				           ...
				           |en = 'The object is used elsewhere in the application.
		...
		Иначе
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Выбранные объекты (%1) уже используются в других местах в приложении.
				           |Не рекомендуется разрешать редактирование из-за риска рассогласования данных.';
				           |en = 'Selected objects (%1) are used elsewhere in the application.
		...
		Если КоличествоСсылок = 1 Тогда
			ТекстСообщения =
				НСтр("ru = 'Объект еще не используется в других местах в приложении.
				           ...
				           |en = 'The object is not used in other places in the application.
				           |You can allow editing it without the risk of data inconsistency.'");
		Иначе
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Выбранные объекты (%1) уже используются в других местах в приложении.
				           |Можно разрешать редактирование без риска рассогласования данных.';
				           |en = 'Selected objects (%1) are used in other places in the application.
