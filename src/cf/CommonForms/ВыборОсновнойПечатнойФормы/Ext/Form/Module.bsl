...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не ЗначениеЗаполнено(ОсновнаяПечатнаяФорма) Тогда
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Не выбрана основная печатная форма';
													|en = 'Default print form is not selected'"), , "ОсновнаяПечатнаяФорма");
		Отказ = Истина;
	КонецЕсли;
